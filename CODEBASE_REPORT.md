...
- **Config:** `reranker_provider` ("embedding"), `rerank_model`, `rerank_score_threshold` (0.0 = off), `rerank_relevance_tolerance` (0.03), `rerank_volatile_tolerance_multiplier` (2.0), `rerank_table_boost` (0.15).
