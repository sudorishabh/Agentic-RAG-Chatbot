...
- handled in 7.955s (build 0.0s, extract Nones, chunk 0.051s, embed+upsert 1.226s, knowledge 6.647s)
...
### 8. Knowledge stage
- status **ok** in 6.64s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:35:06 |
