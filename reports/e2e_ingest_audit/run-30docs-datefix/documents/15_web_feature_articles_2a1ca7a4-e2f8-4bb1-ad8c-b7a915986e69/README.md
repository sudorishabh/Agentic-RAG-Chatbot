# 15_web_feature_articles_2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69

**website** · bundle `feature_articles` · outcome **indexed**

- document_id: `2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69`
- title: Nepal: A wake-up call
- source_key: https://teriin.org/opinion/nepal-wake-call
- handled in 4.232s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.387s, knowledge 3.817s)
...
- JSON:API `node/feature_articles` uuid `2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69` · nid 13374 · created 2026-09-07T08:58:40+00:00 · changed 2026-09-08T09:04:12+00:00
- change detection: status **new** · fingerprint `2026-09-08T09:04:12+00:00` · changed_mark 1788858252 · prior: False

### 2. Extraction
- HTML→text: body 618 chars from 2 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 618 · content_hash `6977bef29066fda0334e795f50aaf708c1b20bca7618b96f0b82423080d8ba65` · doc_version 1
- authors ['Mr Ajay Shankar'] · tags ['Climate change', 'Climate resilience', 'Global warming', 'Net zero emission'] · categories ['Electricity and Renewables', 'Climate Change']
- entity_refs 12 · file_links []
- extra {'bundle': 'feature_articles', 'nid': 13374, 'changed': '2026-09-08T09:04:12+00:00'}

### 4. Dates
- effective_start_date **2026-09-07T08:58:40+00:00** (precision day, source created) · effective_end_date None (precision None)
...
### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 108/108/108 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': '2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69', 'keep_ids': 1}]
...
### 8. Knowledge stage
- status **ok** in 3.81s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 6, 'entities_auto': 4, 'entities_provisional': 2, 'entities_ambiguous': 0, 'entities_unresolved': 0, 'claims_built': 1, 'claims_staged': 0, 'claims_rejected': 1, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `resolution`: ran · counts {'auto': 4, 'provisional': 2, 'ambiguous': 0, 'unresolved': 0, 'cache_recorded': 1} · notes [] · errors []
...
| PASS | canonical | title_equals_node_title | - | Nepal: A wake-up call | Nepal: A wake-up call |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 618 | 618 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | 2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69 | 2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'feature_articles', 'nid': 13374, 'changed': '2026-09-08T0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Electricity and Renewables', 'Climate Change'], 'tag… | {'categories': ['Electricity and Renewables', 'Climate Change'], 'tag… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 6977bef29066fda0334e795f50aaf708c1b20bca7618b96f0b82423080d8ba65 |
| PASS | canonical | body_text_non_empty | - | >0 chars | 618 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2026-09-07T08:58:40+00:00 |
...
| PASS | dates | canonical_date_equals_evidence_value | - | 2026-09-07T08:58:40+00:00 | 2026-09-07T08:58:40+00:00 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 108, 'over': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2026-09-07T08:58:40+00:00 | ['2026-09-07T08:58:40+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': '2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/opinion/nepal-wake-call | https://teriin.org/opinion/nepal-wake-call |
| PASS | mysql | row_fingerprint | - | 2026-09-08T09:04:12+00:00 | 2026-09-08T09:04:12+00:00 |
| PASS | mysql | row_content_hash | - | 6977bef29066fda0334e795f50aaf708c1b20bca7618b96f0b82423080d8ba65 | 6977bef29066fda0334e795f50aaf708c1b20bca7618b96f0b82423080d8ba65 |
...
| PASS | mysql | row_changed_mark | - | 1788858252 | 1788858252 |
| PASS | mysql | row_title | - | Nepal: A wake-up call | Nepal: A wake-up call |
| PASS | mysql | row_url | - | https://teriin.org/opinion/nepal-wake-call | https://teriin.org/opinion/nepal-wake-call |
| PASS | mysql | row_effective_start_date | - | 2026-09-07T08:58:40+00:00 | 2026-09-07 08:58:40 |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:38:55 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | ['Mr Ajay Shankar'] | ['Mr Ajay Shankar'] |
| PASS | mysql | tag_facet_rows | - | ['Climate change', 'Climate resilience', 'Global warming', 'Net zero … | ['Climate change', 'Climate resilience', 'Global warming', 'Net zero … |
| PASS | mysql | theme_rows_match_classification | documents_theme = theme_taxonomy.classify(categories) | [('Climate Change', 'primary', None, 'main'), ('Electricity and Renew… | [('Climate Change', 'primary', None, 'main'), ('Electricity and Renew… |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 6, 'entities_auto': 4, 'enti… | - | {'document_id': '2a1ca7a4-e2f8-4bb1-ad8c-b7a915986e69', 'doc_version'… |
