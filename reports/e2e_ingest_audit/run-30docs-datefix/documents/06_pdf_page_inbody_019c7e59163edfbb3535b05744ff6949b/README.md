...
- handled in 134.071s (build 27.127s, extract 26.115s, chunk 2.912s, embed+upsert 71.349s, knowledge 32.643s)
...
### 4. Dates
- effective_start_date **2020-01-01T00:00:00+00:00** (precision year, source document_text) · effective_end_date None (precision None)
...
### 8. Knowledge stage
- status **partial** in 32.64s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 431, 'chunks_cached': 0, 'mentions': 1673, 'entities_auto': 29, 'entities_provisional': 0, 'entities_ambiguous': 50, 'entities_unresolved': 1594, 'claims_built': 4, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'llm_calls': 8, 'llm_failures': 0, 'llm': 4, 'unknown_predicates': 0, 'built': 4} · notes ["model calls stopped at 8; the document's remaining chunks were not examined"] · errors []
  - stage `validate`: skipped · counts {} · notes ['the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'] · errors [{'id': 'budget', 'error': 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'}]
  - stage `persist`: skipped · counts {} · notes ['the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'] · errors [{'id': 'budget', 'error': 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'}]
  - stage `conflicts`: skipped · counts {} · notes ['the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'] · errors [{'id': 'budget', 'error': 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'}]
  - stage `project`: skipped · counts {} · notes ['the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'] · errors [{'id': 'budget', 'error': 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid'}]
...
| PASS | dates | date_source_is_document_text | - | document_text | document_text |
...
| PASS | mysql | row_date_source | - | document_text | document_text |
| PASS | mysql | row_start_precision | - | year | year |
| PASS | mysql | row_effective_end_date | - | - | - |
| PASS | mysql | row_end_precision | - | - | - |
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:37:02 |
...
| INFO | knowledge | stage_report | status=partial {'chunks_seen': 431, 'chunks_cached': 0, 'mentions': 1673, 'entities_auto'… | - | {'document_id': 'inbody:019c7e59163edfbb3535b05744ff6949b04cef47', 'd… |
| PASS | knowledge | run_row_written | - | 1 | [(1, 'ok')] |
| FAIL | knowledge | run_row_matches_report | - | {'status': 'partial', 'mentions': 1673, 'claims_staged': 0} | {'status': 'ok', 'mentions': 0, 'claims_staged': 0} |
