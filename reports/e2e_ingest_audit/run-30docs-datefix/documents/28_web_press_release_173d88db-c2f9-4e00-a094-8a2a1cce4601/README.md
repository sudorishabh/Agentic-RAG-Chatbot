...
- handled in 8.949s (build 0.0s, extract Nones, chunk 0.012s, embed+upsert 1.644s, knowledge 7.264s)
...
### 8. Knowledge stage
- status **ok** in 7.26s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 4, 'chunks_cached': 0, 'mentions': 13, 'entities_auto': 3, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 10, 'claims_built': 0, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:39:28 |
