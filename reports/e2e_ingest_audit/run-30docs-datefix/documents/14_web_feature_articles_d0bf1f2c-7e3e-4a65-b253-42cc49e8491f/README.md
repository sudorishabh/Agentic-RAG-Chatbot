...
- handled in 3.993s (build 0.0s, extract Nones, chunk 0.002s, embed+upsert 0.531s, knowledge 3.425s)
...
### 8. Knowledge stage
- status **ok** in 3.42s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:38:51 |
