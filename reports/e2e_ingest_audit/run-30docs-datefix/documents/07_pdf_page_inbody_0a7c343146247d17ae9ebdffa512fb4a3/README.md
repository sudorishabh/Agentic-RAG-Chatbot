...
- handled in 65.219s (build 23.911s, extract 23.109s, chunk 2.129s, embed+upsert 9.135s, knowledge 30.014s)
...
### 4. Dates
- effective_start_date **2022-01-01T00:00:00+00:00** (precision year, source document_text) · effective_end_date None (precision None)
...
### 8. Knowledge stage
- status **partial** in 30.0s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 294, 'chunks_cached': 0, 'mentions': 882, 'entities_auto': 11, 'entities_provisional': 0, 'entities_ambiguous': 89, 'entities_unresolved': 782, 'claims_built': 3, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:38:09 |
...
| INFO | knowledge | stage_report | status=partial {'chunks_seen': 294, 'chunks_cached': 0, 'mentions': 882, 'entities_auto':… | - | {'document_id': 'inbody:0a7c343146247d17ae9ebdffa512fb4a3b39a5b2', 'd… |
| PASS | knowledge | run_row_written | - | 1 | [(1, 'ok')] |
| FAIL | knowledge | run_row_matches_report | - | {'status': 'partial', 'mentions': 882, 'claims_staged': 0} | {'status': 'ok', 'mentions': 0, 'claims_staged': 0} |
