# 22_web_events_3c24d94b-f8bb-4475-b147-56dd0c35318f
...
- handled in 4.389s (build 0.0s, extract Nones, chunk 0.005s, embed+upsert 0.388s, knowledge 3.971s)
...
### 8. Knowledge stage
- status **ok** in 3.97s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 3, 'chunks_cached': 0, 'mentions': 15, 'entities_auto': 1, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 14, 'claims_built': 2, 'claims_staged': 0, 'claims_rejected': 2, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'llm_calls': 1, 'llm_failures': 0, 'llm': 2, 'unknown_predicates': 0, 'built': 2} · notes [] · errors []
