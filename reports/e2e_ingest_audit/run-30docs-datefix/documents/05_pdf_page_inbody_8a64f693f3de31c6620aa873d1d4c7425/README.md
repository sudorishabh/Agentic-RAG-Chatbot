...
- handled in 7.558s (build 3.706s, extract 2.078s, chunk 0.2s, embed+upsert 3.432s, knowledge 0.193s)
...
### 8. Knowledge stage
- status **ok** in 0.19s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:35:20 |
