# 29_web_press_release_7126f143-21fe-4372-ac55-07a092503549
...
- handled in 5.693s (build 0.0s, extract Nones, chunk 0.007s, embed+upsert 1.553s, knowledge 4.098s)
...
### 8. Knowledge stage
- status **ok** in 4.09s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 2, 'chunks_cached': 0, 'mentions': 14, 'entities_auto': 2, 'entities_provisional': 0, 'entities_ambiguous': 1, 'entities_unresolved': 11, 'claims_built': 1, 'claims_staged': 0, 'claims_rejected': 1, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:39:37 |
