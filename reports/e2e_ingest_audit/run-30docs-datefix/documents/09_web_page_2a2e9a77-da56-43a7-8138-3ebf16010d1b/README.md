...
- handled in 2.236s (build 0.0s, extract Nones, chunk 0.008s, embed+upsert 0.465s, knowledge 1.728s)
...
### 8. Knowledge stage
- status **ok** in 1.72s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 14:38:43 |
