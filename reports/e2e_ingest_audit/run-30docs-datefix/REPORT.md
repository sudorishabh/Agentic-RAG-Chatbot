...
Run `20260908-143432` started 2026-09-08T14:34:32+00:00 finished 2026-09-08T14:40:05+00:00 · pipeline version `c1.i1.p2.e1` · results in `D:\OneDrive - The Energy and Resources Institute\Desktop\My_Files\Projects\Agentic-RAG-Chatbot\reports\e2e_ingest_audit\run-30docs-datefix`
...
- wall clock for `ingest_drupal`: 283.5s
- stage timings (app.observability.metrics): see `timings.json`

### Post-sweep stages (the same order `workers.tasks.sweep` uses)

- knowledge catch-up: `{'examined': 2, 'ok': 2, 'failed': 0}`
- graph projection: version `graph-project-v1:20260908T143946:a3548f2b` nodes `{'Alias': 2793, 'Entity': 1726, 'Organization': 524, 'Person': 131, 'Predicate': 7, 'Project': 1071}` relationships `{'HAS_ALIAS': 2793}` skipped `{}`
...
- Qdrant: `{'collection': 'e2e_audit_documents', 'exists': True, 'points_count': 1053, 'vector_size': 3072, 'distance': 'Cosine', 'payload_indexes': ['authors', 'categories', 'chunk_index', 'chunk_text', 'document_id', 'effective_start_date', 'is_current', 'is_parent', 'language', 'parent_chunk_id', 'section_type', 'source_type', 'tags']}`
- Neo4j: `{'reachable': True, 'node_labels': {'Alias': 2793, 'Entity': 1726, 'Organization': 524, 'Person': 131, 'Predicate': 7, 'Project': 1071}, 'relationship_types': {'HAS_ALIAS': 2793}, 'current_state_edges': 0, 'projection_versions': {'graph-project-v1:20260908T143946:a3548f2b': 4519}}`
- MySQL row counts:
...
| e2e_audit_documents_assertion_rejection | 8 |
...
| 6 | pdf | page | indexed | TERI Alumni Association | 2020-01-01 | document_text | 98 | 431 | 529 | 0 | skipped | 1 | 06_pdf_page_inbody_019c7e59163edfbb3535b05744ff6949b |
| 7 | pdf | page | indexed | TERI Alumni Association | 2022-01-01 | document_text | 69 | 294 | 363 | 0 | skipped | 1 | 07_pdf_page_inbody_0a7c343146247d17ae9ebdffa512fb4a3 |
...
| dates | date_source_is_document_text | 2 | 0 | 0 | - |
...
| knowledge | run_row_matches_report | 28 | 2 | 0 | 6, 7 |
...
- outcome: **indexed** in 134.071s
- canonical: title “TERI Alumni Association” · 245 section(s) · 618040 chars · hash `f71488117717…` · authors [] · tags [] · categories []
- dates: start 2020-01-01T00:00:00+00:00 (year, document_text) · end None · page rule `bundle_created` · file resolver: OVERRIDE (copyright_statement_corroborated)
...
- knowledge: partial · mentions 1673 · resolved auto/prov/amb/unres 29/0/50/1594 · claims built/staged/rejected 4/0/0 · projection skipped (0 edges)
- knowledge notes: ["model calls stopped at 8; the document's remaining chunks were not examined", 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid', 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid', 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid', 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid']
- neo4j: document stub no · claim nodes 0 · current edges 0
- checks: 86 pass / 1 fail · folder `documents/06_pdf_page_inbody_019c7e59163edfbb3535b05744ff6949b/`
- **failed checks:**
  - `run_row_matches_report` —  (expected {'status': 'partial', 'mentions': 1673, 'claims_staged': 0}, actual {'status': 'ok', 'mentions': 0, 'claims_staged': 0})
...
- outcome: **indexed** in 65.219s
- canonical: title “TERI Alumni Association” · 241 section(s) · 522251 chars · hash `551db333c39e…` · authors [] · tags [] · categories []
- dates: start 2022-01-01T00:00:00+00:00 (year, document_text) · end None · page rule `bundle_created` · file resolver: OVERRIDE (copyright_statement_corroborated)
...
- knowledge: partial · mentions 882 · resolved auto/prov/amb/unres 11/0/89/782 · claims built/staged/rejected 3/0/0 · projection skipped (0 edges)
- knowledge notes: ["model calls stopped at 8; the document's remaining chunks were not examined", 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid', 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid', 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid', 'the stage budget was exhausted; remaining stages were skipped and the run is retryable — everything already written is valid']
- neo4j: document stub no · claim nodes 0 · current edges 0
- checks: 86 pass / 1 fail · folder `documents/07_pdf_page_inbody_0a7c343146247d17ae9ebdffa512fb4a3/`
- **failed checks:**
  - `run_row_matches_report` —  (expected {'status': 'partial', 'mentions': 882, 'claims_staged': 0}, actual {'status': 'ok', 'mentions': 0, 'claims_staged': 0})
...
- mysql: documents=1, ·tag=2, ·date_decision=1, ·entity_mention=15, ·assertion_rejection=2, ·knowledge_run=1, ·attachment=1, ·entity_resolution_decision=15, ·entity_extraction=3, e2e_audit_ingest_log=1, ·entity (referenced)=1
- knowledge: ok · mentions 15 · resolved auto/prov/amb/unres 1/0/0/14 · claims built/staged/rejected 2/0/2 · projection skipped (0 edges)
- neo4j: document stub no · claim nodes 0 · current edges 0
