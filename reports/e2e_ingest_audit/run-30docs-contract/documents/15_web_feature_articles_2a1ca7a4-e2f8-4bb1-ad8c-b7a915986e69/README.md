...
- handled in 2.252s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.398s, knowledge 1.802s)
...
### 8. Knowledge stage
- status **ok** in 1.78s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:07:09 |
