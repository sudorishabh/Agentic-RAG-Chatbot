...
- handled in 2.607s (build 0.0s, extract Nones, chunk 0.002s, embed+upsert 0.425s, knowledge 2.137s)
...
### 8. Knowledge stage
- status **ok** in 2.13s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:07:06 |
