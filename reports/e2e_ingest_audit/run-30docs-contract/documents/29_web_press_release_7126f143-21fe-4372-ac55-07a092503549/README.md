...
- handled in 4.026s (build 0.0s, extract Nones, chunk 0.008s, embed+upsert 1.511s, knowledge 2.466s)
...
### 8. Knowledge stage
- status **ok** in 2.46s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:07:41 |
