# 21_web_news_c00a39be-c021-4e95-9ce0-1c4a1912bc5e

**website** · bundle `news` · outcome **indexed**

- document_id: `c00a39be-c021-4e95-9ce0-1c4a1912bc5e`
- title: Sarbananda Sonowal Charts Course for Zero-Emission Shipping Corridors, Pushes Ports to Fast-Track Green Fuel Readiness
- source_key: https://teriin.org/news/sarbananda-sonowal-charts-course-zero-emission-shipping-corridors-pushes-ports-fast-track
- handled in 0.505s (build 0.0s, extract Nones, chunk 0.002s, embed+upsert 0.422s, knowledge 0.025s)
...
- JSON:API `node/news` uuid `c00a39be-c021-4e95-9ce0-1c4a1912bc5e` · nid 13379 · created 2026-09-03T10:08:28+00:00 · changed 2026-09-08T10:12:22+00:00
- change detection: status **new** · fingerprint `2026-09-08T10:12:22+00:00` · changed_mark 1788862342 · prior: False

### 2. Extraction
- HTML→text: body 289 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 289 · content_hash `c8301da5899fcaf7d07232bcea305d4cf4d0bc5f7835424ef075e8c26e17bbba` · doc_version 1
- authors [] · tags ['Green Shipping', 'Zero emission', 'Green Fuels'] · categories ['Resource Efficiency & Governance']
- entity_refs 4 · file_links []
- extra {'bundle': 'news', 'nid': 13379, 'changed': '2026-09-08T10:12:22+00:00'}

### 4. Dates
- effective_start_date **2026-09-03T00:00:00+00:00** (precision day, source cms_field) · effective_end_date None (precision None)
- rule `bundle_date_field` · source `cms_field` · fields ['field_news_date'] · raw values ['2026-09-03T11:30:03+00:00'] · role date · range_issue None
- date_decision rows in MySQL: 1 — action `keep_page_date` rule `bundle_field_matches_created` candidate 2026-09-03 00:00:00

### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 68/68/68 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': 'c00a39be-c021-4e95-9ce0-1c4a1912bc5e', 'keep_ids': 1}]
...
- counts {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 1, 'entities_auto': 0, 'entities_provisional': 0, 'entities_ambiguous': 1, 'entities_unresolved': 0, 'claims_built': 0, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `resolution`: ran · counts {'auto': 0, 'provisional': 0, 'ambiguous': 1, 'unresolved': 0, 'cache_recorded': 1} · notes [] · errors []
...
| PASS | canonical | title_equals_node_title | - | Sarbananda Sonowal Charts Course for Zero-Emission Shipping Corridors… | Sarbananda Sonowal Charts Course for Zero-Emission Shipping Corridors… |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 289 | 289 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | c00a39be-c021-4e95-9ce0-1c4a1912bc5e | c00a39be-c021-4e95-9ce0-1c4a1912bc5e |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'news', 'nid': 13379, 'changed': '2026-09-08T10:12:22+00:0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Resource Efficiency & Governance'], 'tags': ['Green … | {'categories': ['Resource Efficiency & Governance'], 'tags': ['Green … |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | c8301da5899fcaf7d07232bcea305d4cf4d0bc5f7835424ef075e8c26e17bbba |
| PASS | canonical | body_text_non_empty | - | >0 chars | 289 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 68, 'over': []} |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': 'c00a39be-c021-4e95-9ce0-1c4a1912bc5e', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/news/sarbananda-sonowal-charts-course-zero-emissio… | https://teriin.org/news/sarbananda-sonowal-charts-course-zero-emissio… |
| PASS | mysql | row_fingerprint | - | 2026-09-08T10:12:22+00:00 | 2026-09-08T10:12:22+00:00 |
| PASS | mysql | row_content_hash | - | c8301da5899fcaf7d07232bcea305d4cf4d0bc5f7835424ef075e8c26e17bbba | c8301da5899fcaf7d07232bcea305d4cf4d0bc5f7835424ef075e8c26e17bbba |
...
| PASS | mysql | row_changed_mark | - | 1788862342 | 1788862342 |
| PASS | mysql | row_title | - | Sarbananda Sonowal Charts Course for Zero-Emission Shipping Corridors… | Sarbananda Sonowal Charts Course for Zero-Emission Shipping Corridors… |
| PASS | mysql | row_url | - | https://teriin.org/news/sarbananda-sonowal-charts-course-zero-emissio… | https://teriin.org/news/sarbananda-sonowal-charts-course-zero-emissio… |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:07:16 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | - | - |
| PASS | mysql | tag_facet_rows | - | ['Green Fuels', 'Green Shipping', 'Zero emission'] | ['Green Fuels', 'Green Shipping', 'Zero emission'] |
| PASS | mysql | theme_rows_match_classification | documents_theme = theme_taxonomy.classify(categories) | [('Resource Efficiency & Governance', 'sub', 'Resources & Sustainable… | [('Resource Efficiency & Governance', 'sub', 'Resources & Sustainable… |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 1, 'entities_auto': 0, 'enti… | - | {'document_id': 'c00a39be-c021-4e95-9ce0-1c4a1912bc5e', 'doc_version'… |
