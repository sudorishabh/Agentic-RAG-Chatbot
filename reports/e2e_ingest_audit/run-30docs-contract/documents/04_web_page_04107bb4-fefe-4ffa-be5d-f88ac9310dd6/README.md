...
- handled in 11.373s (build 0.0s, extract Nones, chunk 0.053s, embed+upsert 1.107s, knowledge 10.164s)
...
### 8. Knowledge stage
- status **ok** in 10.16s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:03:29 |
