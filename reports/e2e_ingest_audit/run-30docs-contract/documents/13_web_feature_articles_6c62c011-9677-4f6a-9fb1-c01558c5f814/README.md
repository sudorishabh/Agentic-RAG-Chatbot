# 13_web_feature_articles_6c62c011-9677-4f6a-9fb1-c01558c5f814

**website** · bundle `feature_articles` · outcome **indexed**

- document_id: `6c62c011-9677-4f6a-9fb1-c01558c5f814`
- title: Peace in Ukraine is nowhere in sight
- source_key: https://teriin.org/opinion/peace-ukraine-nowhere-sight
- handled in 2.365s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.432s, knowledge 1.905s)
...
- JSON:API `node/feature_articles` uuid `6c62c011-9677-4f6a-9fb1-c01558c5f814` · nid 13369 · created 2026-09-01T10:55:25+00:00 · changed 2026-09-03T11:09:49+00:00
- change detection: status **new** · fingerprint `2026-09-03T11:09:49+00:00` · changed_mark 1788433789 · prior: False

### 2. Extraction
- HTML→text: body 726 chars from 2 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 726 · content_hash `1dfb6bfa2a94e3ab9ed594dcb925012fdc82081b937185b5c67213e1b6d202f2` · doc_version 1
- authors [] · tags ['Sustainable development'] · categories ['Resources & Sustainable Development']
- entity_refs 6 · file_links []
- extra {'bundle': 'feature_articles', 'nid': 13369, 'changed': '2026-09-03T11:09:49+00:00'}

### 4. Dates
- effective_start_date **2026-09-01T10:55:25+00:00** (precision day, source created) · effective_end_date None (precision None)
...
### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 140/140/140 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': '6c62c011-9677-4f6a-9fb1-c01558c5f814', 'keep_ids': 1}]
...
### 8. Knowledge stage
- status **ok** in 1.9s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 6, 'entities_auto': 4, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 2, 'claims_built': 1, 'claims_staged': 0, 'claims_rejected': 1, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `resolution`: ran · counts {'auto': 4, 'provisional': 0, 'ambiguous': 0, 'unresolved': 2, 'cache_recorded': 1} · notes [] · errors []
...
| PASS | canonical | title_equals_node_title | - | Peace in Ukraine is nowhere in sight | Peace in Ukraine is nowhere in sight |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 726 | 726 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | 6c62c011-9677-4f6a-9fb1-c01558c5f814 | 6c62c011-9677-4f6a-9fb1-c01558c5f814 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'feature_articles', 'nid': 13369, 'changed': '2026-09-03T1… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Resources & Sustainable Development'], 'tags': ['Sus… | {'categories': ['Resources & Sustainable Development'], 'tags': ['Sus… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 1dfb6bfa2a94e3ab9ed594dcb925012fdc82081b937185b5c67213e1b6d202f2 |
| PASS | canonical | body_text_non_empty | - | >0 chars | 726 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2026-09-01T10:55:25+00:00 |
...
| PASS | dates | canonical_date_equals_evidence_value | - | 2026-09-01T10:55:25+00:00 | 2026-09-01T10:55:25+00:00 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 140, 'over': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2026-09-01T10:55:25+00:00 | ['2026-09-01T10:55:25+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': '6c62c011-9677-4f6a-9fb1-c01558c5f814', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/opinion/peace-ukraine-nowhere-sight | https://teriin.org/opinion/peace-ukraine-nowhere-sight |
| PASS | mysql | row_fingerprint | - | 2026-09-03T11:09:49+00:00 | 2026-09-03T11:09:49+00:00 |
| PASS | mysql | row_content_hash | - | 1dfb6bfa2a94e3ab9ed594dcb925012fdc82081b937185b5c67213e1b6d202f2 | 1dfb6bfa2a94e3ab9ed594dcb925012fdc82081b937185b5c67213e1b6d202f2 |
...
| PASS | mysql | row_changed_mark | - | 1788433789 | 1788433789 |
| PASS | mysql | row_title | - | Peace in Ukraine is nowhere in sight | Peace in Ukraine is nowhere in sight |
| PASS | mysql | row_url | - | https://teriin.org/opinion/peace-ukraine-nowhere-sight | https://teriin.org/opinion/peace-ukraine-nowhere-sight |
| PASS | mysql | row_effective_start_date | - | 2026-09-01T10:55:25+00:00 | 2026-09-01 10:55:25 |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:07:04 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | - | - |
| PASS | mysql | tag_facet_rows | - | ['Sustainable development'] | ['Sustainable development'] |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 6, 'entities_auto': 4, 'enti… | - | {'document_id': '6c62c011-9677-4f6a-9fb1-c01558c5f814', 'doc_version'… |
