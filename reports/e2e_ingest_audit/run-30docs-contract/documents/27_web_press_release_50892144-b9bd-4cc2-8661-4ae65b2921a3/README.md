...
- handled in 5.247s (build 0.0s, extract Nones, chunk 0.015s, embed+upsert 0.434s, knowledge 4.732s)
...
### 8. Knowledge stage
- status **ok** in 4.73s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:07:25 |
