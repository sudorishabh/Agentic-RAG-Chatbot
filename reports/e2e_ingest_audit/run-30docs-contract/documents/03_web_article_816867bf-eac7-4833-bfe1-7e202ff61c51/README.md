...
- handled in 1.0s (build 0.0s, extract Nones, chunk 0.031s, embed+upsert 0.85s, knowledge 0.079s)
...
### 8. Knowledge stage
- status **ok** in 0.07s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:03:28 |
