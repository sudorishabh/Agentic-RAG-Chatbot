...
- handled in 57.715s (build 28.995s, extract 26.239s, chunk 2.283s, embed+upsert 7.427s, knowledge 18.971s)
...
### 8. Knowledge stage
- status **ok** in 18.96s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 294, 'chunks_cached': 0, 'mentions': 882, 'entities_auto': 11, 'entities_provisional': 0, 'entities_ambiguous': 89, 'entities_unresolved': 782, 'claims_built': 3, 'claims_staged': 0, 'claims_rejected': 3, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:06:38 |
