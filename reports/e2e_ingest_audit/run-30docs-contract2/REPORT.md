...
Run `20260909-051029` started 2026-09-09T05:10:29+00:00 finished 2026-09-09T05:15:34+00:00 · pipeline version `c1.i1.p2.e1` · results in `D:\OneDrive - The Energy and Resources Institute\Desktop\My_Files\Projects\Agentic-RAG-Chatbot\reports\e2e_ingest_audit\run-30docs-contract2`
...
- wall clock for `ingest_drupal`: 254.3s
...
- graph projection: version `graph-project-v1:20260909T051513:e0a82b90` nodes `{'Alias': 2793, 'Entity': 1726, 'Organization': 524, 'Person': 131, 'Predicate': 7, 'Project': 1071}` relationships `{'HAS_ALIAS': 2793}` skipped `{}`
...
- Neo4j: `{'reachable': True, 'node_labels': {'Alias': 2793, 'Entity': 1726, 'Organization': 524, 'Person': 131, 'Predicate': 7, 'Project': 1071}, 'relationship_types': {'HAS_ALIAS': 2793}, 'current_state_edges': 0, 'projection_versions': {'graph-project-v1:20260909T051513:e0a82b90': 4519}}`
- MySQL row counts:
...
| e2e_audit_documents_assertion_rejection | 11 |
...
| 6 | pdf | page | indexed | TERI Alumni Association | 2020-01-01 | document_copyright | 98 | 431 | 529 | 0 | skipped | 0 | 06_pdf_page_inbody_019c7e59163edfbb3535b05744ff6949b |
| 7 | pdf | page | indexed | TERI Alumni Association | 2022-01-01 | document_copyright | 69 | 294 | 363 | 0 | skipped | 0 | 07_pdf_page_inbody_0a7c343146247d17ae9ebdffa512fb4a3 |
...
- neo4j: document stub no · claim nodes 0 · current edges 0
- checks: 88 pass / 0 fail · folder `documents/06_pdf_page_inbody_019c7e59163edfbb3535b05744ff6949b/`
...
- mysql: documents=1, ·date_decision=1, ·entity_mention=882, ·assertion_rejection=1, ·knowledge_run=1, ·attachment (as file)=1, ·entity_resolution_decision=882, ·entity_extraction=294, e2e_audit_ingest_log=1, ·entity (referenced)=6
- knowledge: ok · mentions 882 · resolved auto/prov/amb/unres 11/0/89/782 · claims built/staged/rejected 1/0/1 · projection skipped (0 edges)
- knowledge notes: ["model calls stopped at 8; the document's remaining chunks were not examined"]
- neo4j: document stub no · claim nodes 0 · current edges 0
- checks: 88 pass / 0 fail · folder `documents/07_pdf_page_inbody_0a7c343146247d17ae9ebdffa512fb4a3/`
