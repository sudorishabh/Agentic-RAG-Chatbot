...
- handled in 4.571s (build 0.0s, extract Nones, chunk 0.006s, embed+upsert 0.752s, knowledge 3.784s)
...
### 8. Knowledge stage
- status **ok** in 3.78s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:15:00 |
