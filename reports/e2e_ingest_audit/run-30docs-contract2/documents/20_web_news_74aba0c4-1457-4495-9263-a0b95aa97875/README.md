# 20_web_news_74aba0c4-1457-4495-9263-a0b95aa97875

**website** · bundle `news` · outcome **indexed**

- document_id: `74aba0c4-1457-4495-9263-a0b95aa97875`
- title: ISA SIDS and GRIHA Launch ISA-iSUN Design Challenge to Promote Solar and Climate-Resilient Tourism Infrastructure in Island Nations
- source_key: https://teriin.org/news/isa-sids-and-griha-launch-isa-isun-design-challenge-promote-solar-and-climate-resilient
- handled in 0.491s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.419s, knowledge 0.019s)
...
- JSON:API `node/news` uuid `74aba0c4-1457-4495-9263-a0b95aa97875` · nid 13378 · created 2026-09-04T09:31:12+00:00 · changed 2026-09-08T09:34:52+00:00
- change detection: status **new** · fingerprint `2026-09-08T09:34:52+00:00` · changed_mark 1788860092 · prior: False

### 2. Extraction
- HTML→text: body 274 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 274 · content_hash `d6d51130fa369514d2cc880c1033c810c7c348e6f672bcb0f8db71adec5138ee` · doc_version 1
- authors [] · tags ['GRIHA Council', 'Solar energy', 'Climate resilience'] · categories ['Sustainable Habitat']
- entity_refs 4 · file_links []
- extra {'bundle': 'news', 'nid': 13378, 'changed': '2026-09-08T09:34:52+00:00'}

### 4. Dates
- effective_start_date **2026-09-04T00:00:00+00:00** (precision day, source cms_field) · effective_end_date None (precision None)
- rule `bundle_date_field` · source `cms_field` · fields ['field_news_date'] · raw values ['2026-09-04T11:30:03+00:00'] · role date · range_issue None
- date_decision rows in MySQL: 1 — action `keep_page_date` rule `bundle_field_matches_created` candidate 2026-09-04 00:00:00

### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 53/53/53 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': '74aba0c4-1457-4495-9263-a0b95aa97875', 'keep_ids': 1}]
...
- counts {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 2, 'entities_auto': 0, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 2, 'claims_built': 0, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `resolution`: ran · counts {'auto': 0, 'provisional': 0, 'ambiguous': 0, 'unresolved': 2, 'cache_recorded': 1} · notes [] · errors []
...
| PASS | canonical | title_equals_node_title | - | ISA SIDS and GRIHA Launch ISA-iSUN Design Challenge to Promote Solar … | ISA SIDS and GRIHA Launch ISA-iSUN Design Challenge to Promote Solar … |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 274 | 274 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | 74aba0c4-1457-4495-9263-a0b95aa97875 | 74aba0c4-1457-4495-9263-a0b95aa97875 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'news', 'nid': 13378, 'changed': '2026-09-08T09:34:52+00:0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Sustainable Habitat'], 'tags': ['GRIHA Council', 'So… | {'categories': ['Sustainable Habitat'], 'tags': ['GRIHA Council', 'So… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | d6d51130fa369514d2cc880c1033c810c7c348e6f672bcb0f8db71adec5138ee |
| PASS | canonical | body_text_non_empty | - | >0 chars | 274 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2026-09-04T00:00:00+00:00 |
| PASS | dates | effective_date_evidence_present | - | - | - |
| INFO | dates | website_date_rule | rule=bundle_date_field source=cms_field fields=['field_news_date'] | - | {'rule': 'bundle_date_field', 'source': 'cms_field', 'fields': ['fiel… |
| PASS | dates | canonical_date_equals_evidence_value | - | 2026-09-04T00:00:00+00:00 | 2026-09-04T00:00:00+00:00 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 53, 'over': []} |
...
| PASS | chunks | source_lines_covered_by_chunks | 100.000% of 1 source lines appear verbatim in some chunk | >=98% | {'coverage': 1.0, 'missing_sample': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2026-09-04T00:00:00+00:00 | ['2026-09-04T00:00:00+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': '74aba0c4-1457-4495-9263-a0b95aa97875', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/news/isa-sids-and-griha-launch-isa-isun-design-cha… | https://teriin.org/news/isa-sids-and-griha-launch-isa-isun-design-cha… |
| PASS | mysql | row_fingerprint | - | 2026-09-08T09:34:52+00:00 | 2026-09-08T09:34:52+00:00 |
| PASS | mysql | row_content_hash | - | d6d51130fa369514d2cc880c1033c810c7c348e6f672bcb0f8db71adec5138ee | d6d51130fa369514d2cc880c1033c810c7c348e6f672bcb0f8db71adec5138ee |
| PASS | mysql | row_doc_version | - | 1 | 1 |
| PASS | mysql | row_pipeline_version | - | c1.i1.p2.e1 | c1.i1.p2.e1 |
| PASS | mysql | row_bundle | - | news | news |
| PASS | mysql | row_entity_type | - | node | node |
| PASS | mysql | row_changed_mark | - | 1788860092 | 1788860092 |
| PASS | mysql | row_title | - | ISA SIDS and GRIHA Launch ISA-iSUN Design Challenge to Promote Solar … | ISA SIDS and GRIHA Launch ISA-iSUN Design Challenge to Promote Solar … |
| PASS | mysql | row_url | - | https://teriin.org/news/isa-sids-and-griha-launch-isa-isun-design-cha… | https://teriin.org/news/isa-sids-and-griha-launch-isa-isun-design-cha… |
| PASS | mysql | row_effective_start_date | - | 2026-09-04T00:00:00+00:00 | 2026-09-04 00:00:00 |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:14:50 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | - | - |
| PASS | mysql | tag_facet_rows | - | ['Climate resilience', 'GRIHA Council', 'Solar energy'] | ['Climate resilience', 'GRIHA Council', 'Solar energy'] |
| PASS | mysql | theme_rows_match_classification | documents_theme = theme_taxonomy.classify(categories) | [('Sustainable Habitat', 'primary', None, 'main')] | [('Sustainable Habitat', 'primary', None, 'main')] |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 2, 'entities_auto': 0, 'enti… | - | {'document_id': '74aba0c4-1457-4495-9263-a0b95aa97875', 'doc_version'… |
