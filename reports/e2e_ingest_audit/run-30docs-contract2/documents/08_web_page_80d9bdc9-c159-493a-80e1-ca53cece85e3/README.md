...
- handled in 3.182s (build 0.0s, extract Nones, chunk 0.048s, embed+upsert 3.019s, knowledge 0.089s)
...
### 8. Knowledge stage
- status **ok** in 0.08s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:14:35 |
