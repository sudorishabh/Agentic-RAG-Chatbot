...
- handled in 138.669s (build 38.523s, extract 37.313s, chunk 3.375s, embed+upsert 70.842s, knowledge 25.887s)
...
### 8. Knowledge stage
- status **ok** in 25.88s · knowledge_version `kv1:57e6b192246add32`
...
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `validate`: ran · counts {'accepted': 0, 'rejected': 3, 'rejected_missing_object_entity': 2, 'rejected_type_violation': 1} · notes [] · errors []
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:13:12 |
