...
- handled in 9.717s (build 5.689s, extract 2.851s, chunk 0.263s, embed+upsert 3.224s, knowledge 0.507s)
...
### 8. Knowledge stage
- status **ok** in 0.5s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:11:19 |
