# 10_web_completed_projects_36a999eb-b7c7-47fd-ac69-55f97841a9d3

**website** · bundle `completed_projects` · outcome **indexed**

- document_id: `36a999eb-b7c7-47fd-ac69-55f97841a9d3`
- title: Science Technology and Innovation Hub in Gaondongrem, Goa
- source_key: https://teriin.org/project/science-technology-and-innovation-hub-gaondongrem-goa
- handled in 0.609s (build 0.0s, extract Nones, chunk 0.005s, embed+upsert 0.531s, knowledge 0.027s)
...
- JSON:API `node/completed_projects` uuid `36a999eb-b7c7-47fd-ac69-55f97841a9d3` · nid 13181 · created 2026-06-19T04:16:09+00:00 · changed 2026-08-31T08:30:58+00:00
- change detection: status **new** · fingerprint `2026-08-31T08:30:58+00:00` · changed_mark 1788165058 · prior: False

### 2. Extraction
- HTML→text: body 3589 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 3589 · content_hash `37fbdaa7b370dfb29d52ee2081de537d3783a882b023d9d2f2447abf7a3c5564` · doc_version 1
- authors [] · tags ['Sustainable Livelihood'] · categories ['Marine and Coastal']
- entity_refs 4 · file_links []
- extra {'bundle': 'completed_projects', 'nid': 13181, 'changed': '2026-08-31T08:30:58+00:00'}

### 4. Dates
- effective_start_date **2023-01-23T00:00:00+00:00** (precision day, source cms_field) · effective_end_date 2026-01-22T00:00:00+00:00 (precision day)
- rule `bundle_date_field` · source `cms_field` · fields ['field_completed_start_date', 'field_completed_end_date'] · raw values ['2023-01-23T04:30:00+00:00', '2026-01-22T11:30:00+00:00'] · role range_start · range_issue None
- date_decision rows in MySQL: 1 — action `propose_override` rule `bundle_date_field` candidate 2023-01-23 00:00:00

### 5. Chunks
- 0 parent(s), 3 child(ren) · child tokens min/avg/max 186/201/230 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 3 · indexer reported 3
- delete_document calls: [{'document_id': '36a999eb-b7c7-47fd-ac69-55f97841a9d3', 'keep_ids': 3}]
...
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'cms': 0, 'llm_calls': 0, 'llm_failures': 0, 'llm': 0, 'unknown_predicates': 0, 'built': 0} · notes [] · errors []
...
| PASS | canonical | title_equals_node_title | - | Science Technology and Innovation Hub in Gaondongrem, Goa | Science Technology and Innovation Hub in Gaondongrem, Goa |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 3589 | 3589 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | 36a999eb-b7c7-47fd-ac69-55f97841a9d3 | 36a999eb-b7c7-47fd-ac69-55f97841a9d3 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'completed_projects', 'nid': 13181, 'changed': '2026-08-31… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Marine and Coastal'], 'tags': ['Sustainable Liveliho… | {'categories': ['Marine and Coastal'], 'tags': ['Sustainable Liveliho… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 37fbdaa7b370dfb29d52ee2081de537d3783a882b023d9d2f2447abf7a3c5564 |
| PASS | canonical | body_text_non_empty | - | >0 chars | 3589 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2023-01-23T00:00:00+00:00 |
...
| PASS | dates | canonical_date_equals_evidence_value | - | 2023-01-23T00:00:00+00:00 | 2023-01-23T00:00:00+00:00 |
| PASS | dates | canonical_end_equals_evidence_end | - | 2026-01-22T00:00:00+00:00 | 2026-01-22T00:00:00+00:00 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 230, 'over': []} |
...
| PASS | chunks | source_lines_covered_by_chunks | 100.000% of 24 source lines appear verbatim in some chunk | >=98% | {'coverage': 1.0, 'missing_sample': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2023-01-23T00:00:00+00:00 | ['2023-01-23T00:00:00+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 3 | [{'document_id': '36a999eb-b7c7-47fd-ac69-55f97841a9d3', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/project/science-technology-and-innovation-hub-gaon… | https://teriin.org/project/science-technology-and-innovation-hub-gaon… |
| PASS | mysql | row_fingerprint | - | 2026-08-31T08:30:58+00:00 | 2026-08-31T08:30:58+00:00 |
| PASS | mysql | row_content_hash | - | 37fbdaa7b370dfb29d52ee2081de537d3783a882b023d9d2f2447abf7a3c5564 | 37fbdaa7b370dfb29d52ee2081de537d3783a882b023d9d2f2447abf7a3c5564 |
...
| PASS | mysql | row_changed_mark | - | 1788165058 | 1788165058 |
| PASS | mysql | row_title | - | Science Technology and Innovation Hub in Gaondongrem, Goa | Science Technology and Innovation Hub in Gaondongrem, Goa |
| PASS | mysql | row_url | - | https://teriin.org/project/science-technology-and-innovation-hub-gaon… | https://teriin.org/project/science-technology-and-innovation-hub-gaon… |
| PASS | mysql | row_effective_start_date | - | 2023-01-23T00:00:00+00:00 | 2023-01-23 00:00:00 |
| PASS | mysql | row_date_source | - | cms_field | cms_field |
| PASS | mysql | row_start_precision | - | day | day |
| PASS | mysql | row_effective_end_date | - | 2026-01-22T00:00:00+00:00 | 2026-01-22 00:00:00 |
| PASS | mysql | row_end_precision | - | day | day |
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:14:38 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | - | - |
| PASS | mysql | tag_facet_rows | - | ['Sustainable Livelihood'] | ['Sustainable Livelihood'] |
| PASS | mysql | theme_rows_match_classification | documents_theme = theme_taxonomy.classify(categories) | [('Marine and Coastal', 'sub', None, None)] | [('Marine and Coastal', 'sub', None, None)] |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 3, 'chunks_cached': 0, 'mentions': 2, 'entities_auto': 0, 'enti… | - | {'document_id': '36a999eb-b7c7-47fd-ac69-55f97841a9d3', 'doc_version'… |
