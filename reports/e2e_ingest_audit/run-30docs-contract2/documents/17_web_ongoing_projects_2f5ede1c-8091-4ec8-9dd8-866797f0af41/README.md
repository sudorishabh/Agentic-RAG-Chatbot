...
- handled in 1.964s (build 0.0s, extract Nones, chunk 0.005s, embed+upsert 0.411s, knowledge 1.517s)
...
### 8. Knowledge stage
- status **ok** in 1.51s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:14:47 |
