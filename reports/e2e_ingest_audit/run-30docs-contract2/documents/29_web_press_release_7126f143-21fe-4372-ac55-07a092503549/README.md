...
- handled in 3.693s (build 0.0s, extract Nones, chunk 0.006s, embed+upsert 1.723s, knowledge 1.932s)
...
### 8. Knowledge stage
- status **ok** in 1.93s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-09 05:15:09 |
