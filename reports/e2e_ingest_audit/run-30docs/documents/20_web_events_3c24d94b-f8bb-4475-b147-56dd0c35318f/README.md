# 20_web_events_3c24d94b-f8bb-4475-b147-56dd0c35318f
...
- handled in 0.815s (build 0.0s, extract Nones, chunk 0.004s, embed+upsert 0.49s, knowledge 0.299s)
...
- counts {'chunks_seen': 3, 'chunks_cached': 0, 'mentions': 15, 'entities_auto': 1, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 14, 'claims_built': 0, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
...
| FAIL | mysql | row_effective_end_date | - | 2026-08-21T00:00:00+00:00 | - |
| FAIL | mysql | row_end_precision | - | day | - |
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:50:05 |
