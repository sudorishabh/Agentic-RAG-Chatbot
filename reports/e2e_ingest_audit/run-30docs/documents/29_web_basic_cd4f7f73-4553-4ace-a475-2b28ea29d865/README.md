# 29_web_basic_cd4f7f73-4553-4ace-a475-2b28ea29d865

**website** · bundle `basic` · outcome **indexed**

- document_id: `cd4f7f73-4553-4ace-a475-2b28ea29d865`
- title: New in Environment & Public Health
- source_key: basic/cd4f7f73-4553-4ace-a475-2b28ea29d865
- handled in 0.397s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.371s, knowledge 0.007s)
...
- JSON:API `block_content/basic` uuid `cd4f7f73-4553-4ace-a475-2b28ea29d865` · nid None · created 2018-01-25T09:57:44+00:00 · changed 2026-08-19T06:33:35+00:00
- change detection: status **new** · fingerprint `2026-08-19T06:33:35+00:00` · changed_mark 1787121215 · prior: False

### 2. Extraction
- HTML→text: body 680 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 680 · content_hash `4c2de96b0901300e3e234b77fcc476e4485f41cf82c5d7b968dbf44f3d7fdade` · doc_version 1
- authors [] · tags [] · categories []
- entity_refs 0 · file_links []
- extra {'bundle': 'basic', 'nid': None, 'changed': '2026-08-19T06:33:35+00:00'}

### 4. Dates
- effective_start_date **2018-01-25T09:57:44+00:00** (precision day, source created) · effective_end_date None (precision None)
- rule `bundle_unmapped` · source `created` · fields [] · raw values [] · role created_stamp · range_issue None
- date_decision rows in MySQL: 0

### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 159/159/159 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': 'cd4f7f73-4553-4ace-a475-2b28ea29d865', 'keep_ids': 1}]
...
| PASS | canonical | title_equals_node_title | - | New in Environment & Public Health | New in Environment & Public Health |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 680 | 680 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | cd4f7f73-4553-4ace-a475-2b28ea29d865 | cd4f7f73-4553-4ace-a475-2b28ea29d865 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'basic', 'nid': None, 'changed': '2026-08-19T06:33:35+00:0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': [], 'tags': [], 'authors': []} | {'categories': [], 'tags': [], 'authors': []} |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 4c2de96b0901300e3e234b77fcc476e4485f41cf82c5d7b968dbf44f3d7fdade |
| PASS | canonical | body_text_non_empty | - | >0 chars | 680 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2018-01-25T09:57:44+00:00 |
...
| PASS | dates | canonical_date_equals_evidence_value | - | 2018-01-25T09:57:44+00:00 | 2018-01-25T09:57:44+00:00 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=512 | 512 | {'max_child_tokens': 159, 'over': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2018-01-25T09:57:44+00:00 | ['2018-01-25T09:57:44+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': 'cd4f7f73-4553-4ace-a475-2b28ea29d865', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | basic/cd4f7f73-4553-4ace-a475-2b28ea29d865 | basic/cd4f7f73-4553-4ace-a475-2b28ea29d865 |
| PASS | mysql | row_fingerprint | - | 2026-08-19T06:33:35+00:00 | 2026-08-19T06:33:35+00:00 |
| PASS | mysql | row_content_hash | - | 4c2de96b0901300e3e234b77fcc476e4485f41cf82c5d7b968dbf44f3d7fdade | 4c2de96b0901300e3e234b77fcc476e4485f41cf82c5d7b968dbf44f3d7fdade |
...
| PASS | mysql | row_changed_mark | - | 1787121215 | 1787121215 |
| PASS | mysql | row_title | - | New in Environment & Public Health | New in Environment & Public Health |
| PASS | mysql | row_url | - | - | - |
| PASS | mysql | row_effective_start_date | - | 2018-01-25T09:57:44+00:00 | 2018-01-25 09:57:44 |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 0, 'entities_auto': 0, 'enti… | - | {'document_id': 'cd4f7f73-4553-4ace-a475-2b28ea29d865', 'doc_version'… |
