...
- handled in 0.409s (build 0.0s, extract Nones, chunk 0.003s, embed+upsert 0.357s, knowledge 0.026s)
...
- authors [] · tags ['Transport'] · categories ['Transport', 'True']
...
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'llm_calls': 0, 'llm': 0, 'unknown_predicates': 0, 'built': 0} · notes ['this document has no canonical PROJECT entity yet; seeding is a global pass (scripts.build_knowledge), and its claims will be staged once it runs'] · errors []
...
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Transport', 'True'], 'tags': ['Transport'], 'authors… | {'categories': ['Transport', 'True'], 'tags': ['Transport'], 'authors… |
...
| FAIL | mysql | row_effective_end_date | - | 2026-09-02T00:00:00+00:00 | - |
