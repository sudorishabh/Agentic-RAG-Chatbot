# 17_web_news_a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1

**website** · bundle `news` · outcome **indexed**

- document_id: `a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1`
- title: Sarbananda Sonowal pushes zero-emission shipping corridors, urges ports to fast-track green fuel readiness
- source_key: https://teriin.org/news/sarbananda-sonowal-pushes-zero-emission-shipping-corridors-urges-ports-fast-track-green-fuel
- handled in 0.424s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.387s, knowledge 0.012s)
...
- JSON:API `node/news` uuid `a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1` · nid 13376 · created 2026-09-03T09:20:28+00:00 · changed 2026-09-08T09:27:15+00:00
- change detection: status **new** · fingerprint `2026-09-08T09:27:15+00:00` · changed_mark 1788859635 · prior: False

### 2. Extraction
- HTML→text: body 281 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 281 · content_hash `9defd4c074c02319ab2f9086c45213262d111f63a59b366820bf910e028e1d9d` · doc_version 1
- authors [] · tags ['Zero emission', 'Green Shipping', 'Green Fuels'] · categories ['Resource Efficiency & Governance']
- entity_refs 4 · file_links []
- extra {'bundle': 'news', 'nid': 13376, 'changed': '2026-09-08T09:27:15+00:00'}
...
### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 63/63/63 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': 'a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1', 'keep_ids': 1}]
...
| PASS | canonical | title_equals_node_title | - | Sarbananda Sonowal pushes zero-emission shipping corridors, urges por… | Sarbananda Sonowal pushes zero-emission shipping corridors, urges por… |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 281 | 281 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1 | a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'news', 'nid': 13376, 'changed': '2026-09-08T09:27:15+00:0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Resource Efficiency & Governance'], 'tags': ['Zero e… | {'categories': ['Resource Efficiency & Governance'], 'tags': ['Zero e… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 9defd4c074c02319ab2f9086c45213262d111f63a59b366820bf910e028e1d9d |
| PASS | canonical | body_text_non_empty | - | >0 chars | 281 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 63, 'over': []} |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': 'a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/news/sarbananda-sonowal-pushes-zero-emission-shipp… | https://teriin.org/news/sarbananda-sonowal-pushes-zero-emission-shipp… |
| PASS | mysql | row_fingerprint | - | 2026-09-08T09:27:15+00:00 | 2026-09-08T09:27:15+00:00 |
| PASS | mysql | row_content_hash | - | 9defd4c074c02319ab2f9086c45213262d111f63a59b366820bf910e028e1d9d | 9defd4c074c02319ab2f9086c45213262d111f63a59b366820bf910e028e1d9d |
...
| PASS | mysql | row_changed_mark | - | 1788859635 | 1788859635 |
| PASS | mysql | row_title | - | Sarbananda Sonowal pushes zero-emission shipping corridors, urges por… | Sarbananda Sonowal pushes zero-emission shipping corridors, urges por… |
| PASS | mysql | row_url | - | https://teriin.org/news/sarbananda-sonowal-pushes-zero-emission-shipp… | https://teriin.org/news/sarbananda-sonowal-pushes-zero-emission-shipp… |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:50:03 |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 1, 'entities_auto': 0, 'enti… | - | {'document_id': 'a29620f8-5a7e-4e2a-9fc6-3e9c59453fb1', 'doc_version'… |
