# 18_web_news_b9d714ff-34cd-4d73-b67e-083c80936ebd

**website** · bundle `news` · outcome **indexed**

- document_id: `b9d714ff-34cd-4d73-b67e-083c80936ebd`
...
- source_key: https://teriin.org/news/teri-and-adb-convene-regional-knowledge-sharing-session-strengthening-transport-related
- handled in 0.404s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.368s, knowledge 0.008s)
...
- JSON:API `node/news` uuid `b9d714ff-34cd-4d73-b67e-083c80936ebd` · nid 13377 · created 2026-09-03T09:27:39+00:00 · changed 2026-09-08T09:30:49+00:00
- change detection: status **new** · fingerprint `2026-09-08T09:30:49+00:00` · changed_mark 1788859849 · prior: False

### 2. Extraction
- HTML→text: body 188 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 188 · content_hash `ef4a44b6e63c2274bc0c98436fc84f8355d3db1cbe8184cda30fef62d05f2f91` · doc_version 1
- authors [] · tags ['Climate action', 'Climate change'] · categories ['Transport']
- entity_refs 3 · file_links []
- extra {'bundle': 'news', 'nid': 13377, 'changed': '2026-09-08T09:30:49+00:00'}
...
### 5. Chunks
- 0 parent(s), 1 child(ren) · child tokens min/avg/max 40/40/40 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 1 · indexer reported 1
- delete_document calls: [{'document_id': 'b9d714ff-34cd-4d73-b67e-083c80936ebd', 'keep_ids': 1}]
...
| PASS | canonical | body_is_single_section | Website body becomes one section. | 188 | 188 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | b9d714ff-34cd-4d73-b67e-083c80936ebd | b9d714ff-34cd-4d73-b67e-083c80936ebd |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'news', 'nid': 13377, 'changed': '2026-09-08T09:30:49+00:0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Transport'], 'tags': ['Climate action', 'Climate cha… | {'categories': ['Transport'], 'tags': ['Climate action', 'Climate cha… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | ef4a44b6e63c2274bc0c98436fc84f8355d3db1cbe8184cda30fef62d05f2f91 |
| PASS | canonical | body_text_non_empty | - | >0 chars | 188 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 40, 'over': []} |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': 'b9d714ff-34cd-4d73-b67e-083c80936ebd', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/news/teri-and-adb-convene-regional-knowledge-shari… | https://teriin.org/news/teri-and-adb-convene-regional-knowledge-shari… |
| PASS | mysql | row_fingerprint | - | 2026-09-08T09:30:49+00:00 | 2026-09-08T09:30:49+00:00 |
| PASS | mysql | row_content_hash | - | ef4a44b6e63c2274bc0c98436fc84f8355d3db1cbe8184cda30fef62d05f2f91 | ef4a44b6e63c2274bc0c98436fc84f8355d3db1cbe8184cda30fef62d05f2f91 |
...
| PASS | mysql | row_changed_mark | - | 1788859849 | 1788859849 |
...
| PASS | mysql | row_url | - | https://teriin.org/news/teri-and-adb-convene-regional-knowledge-shari… | https://teriin.org/news/teri-and-adb-convene-regional-knowledge-shari… |
...
| PASS | mysql | tag_facet_rows | - | ['Climate action', 'Climate change'] | ['Climate action', 'Climate change'] |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 0, 'entities_auto': 0, 'enti… | - | {'document_id': 'b9d714ff-34cd-4d73-b67e-083c80936ebd', 'doc_version'… |
