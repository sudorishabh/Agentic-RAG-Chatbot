...
- handled in 1.249s (build 0.0s, extract Nones, chunk 0.019s, embed+upsert 1.156s, knowledge 0.054s)
...
### 8. Knowledge stage
- status **ok** in 0.05s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:46:47 |
