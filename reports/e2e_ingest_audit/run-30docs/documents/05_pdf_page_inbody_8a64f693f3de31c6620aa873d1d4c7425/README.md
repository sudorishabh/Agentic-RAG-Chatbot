...
- file: TERI-Alumni-Quarterly-Inaugural-Issue.pdf · origin `inbody` · description Read Newsletter
- handled in 6.686s (build 3.37s, extract 1.552s, chunk 0.138s, embed+upsert 3.005s, knowledge 0.154s)
...
### 8. Knowledge stage
- status **ok** in 0.15s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | canonical | title_precedence_description_node_filename | title = file.description or node.title or filename | Read Newsletter | Read Newsletter |
...
| PASS | mysql | row_title | - | Read Newsletter | Read Newsletter |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:46:56 |
