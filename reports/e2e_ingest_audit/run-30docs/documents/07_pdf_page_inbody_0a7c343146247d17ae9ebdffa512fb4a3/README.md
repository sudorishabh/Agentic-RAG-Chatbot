...
- file: Book_on_Dr_RK_Pachauri_II.pdf · origin `inbody` · description TERI Bookstore
- handled in 64.299s (build 14.004s, extract 13.505s, chunk 1.141s, embed+upsert 42.169s, knowledge 6.946s)
...
### 8. Knowledge stage
- status **ok** in 6.94s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 294, 'chunks_cached': 0, 'mentions': 882, 'entities_auto': 11, 'entities_provisional': 0, 'entities_ambiguous': 89, 'entities_unresolved': 782, 'claims_built': 0, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:49:31 |
