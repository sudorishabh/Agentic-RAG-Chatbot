...
- handled in 0.395s (build 0.0s, extract Nones, chunk 0.003s, embed+upsert 0.348s, knowledge 0.02s)
...
- authors [] · tags ['Sustainable Livelihood'] · categories ['Marine and Coastal', 'True']
...
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'cms': 0, 'llm_calls': 0, 'llm': 0, 'unknown_predicates': 0, 'built': 0} · notes [] · errors []
...
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Marine and Coastal', 'True'], 'tags': ['Sustainable … | {'categories': ['Marine and Coastal', 'True'], 'tags': ['Sustainable … |
...
| FAIL | mysql | row_effective_end_date | - | 2026-01-22T00:00:00+00:00 | - |
| FAIL | mysql | row_end_precision | - | day | - |
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:49:42 |
