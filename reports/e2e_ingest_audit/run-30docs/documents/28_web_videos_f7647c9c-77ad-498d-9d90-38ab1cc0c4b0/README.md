# 28_web_videos_f7647c9c-77ad-498d-9d90-38ab1cc0c4b0

**website** · bundle `videos` · outcome **indexed**

- document_id: `f7647c9c-77ad-498d-9d90-38ab1cc0c4b0`
- title: Celebrating the Clean Kilowatt: Akshay Urja Diwas
- source_key: https://teriin.org/video/celebrating-clean-kilowatt-akshay-urja-diwas
- handled in 0.404s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.369s, knowledge 0.014s)
...
- JSON:API `node/videos` uuid `f7647c9c-77ad-498d-9d90-38ab1cc0c4b0` · nid 13357 · created 2026-08-27T04:49:55+00:00 · changed 2026-08-27T04:51:46+00:00
- change detection: status **new** · fingerprint `2026-08-27T04:51:46+00:00` · changed_mark 1787806306 · prior: False

### 2. Extraction
- HTML→text: body 495 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 495 · content_hash `57d7f128d3a4a0890692ca9d5c06c118e123b25f551f5dcf1ff625f3458414d2` · doc_version 1
- authors [] · tags ['Energy transitions', 'Clean energy', 'Renewable energy'] · categories ['Electricity and Renewables']
- entity_refs 7 · file_links []
- extra {'bundle': 'videos', 'nid': 13357, 'changed': '2026-08-27T04:51:46+00:00'}

### 4. Dates
- effective_start_date **2026-08-27T04:49:55+00:00** (precision day, source created) · effective_end_date None (precision None)
...
- delete_document calls: [{'document_id': 'f7647c9c-77ad-498d-9d90-38ab1cc0c4b0', 'keep_ids': 1}]
...
| PASS | canonical | title_equals_node_title | - | Celebrating the Clean Kilowatt: Akshay Urja Diwas | Celebrating the Clean Kilowatt: Akshay Urja Diwas |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 495 | 495 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | f7647c9c-77ad-498d-9d90-38ab1cc0c4b0 | f7647c9c-77ad-498d-9d90-38ab1cc0c4b0 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'videos', 'nid': 13357, 'changed': '2026-08-27T04:51:46+00… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Electricity and Renewables'], 'tags': ['Energy trans… | {'categories': ['Electricity and Renewables'], 'tags': ['Energy trans… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 57d7f128d3a4a0890692ca9d5c06c118e123b25f551f5dcf1ff625f3458414d2 |
| PASS | canonical | body_text_non_empty | - | >0 chars | 495 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2026-08-27T04:49:55+00:00 |
...
| PASS | dates | canonical_date_equals_evidence_value | - | 2026-08-27T04:49:55+00:00 | 2026-08-27T04:49:55+00:00 |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 120, 'over': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2026-08-27T04:49:55+00:00 | ['2026-08-27T04:49:55+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 1 | [{'document_id': 'f7647c9c-77ad-498d-9d90-38ab1cc0c4b0', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/video/celebrating-clean-kilowatt-akshay-urja-diwas | https://teriin.org/video/celebrating-clean-kilowatt-akshay-urja-diwas |
| PASS | mysql | row_fingerprint | - | 2026-08-27T04:51:46+00:00 | 2026-08-27T04:51:46+00:00 |
| PASS | mysql | row_content_hash | - | 57d7f128d3a4a0890692ca9d5c06c118e123b25f551f5dcf1ff625f3458414d2 | 57d7f128d3a4a0890692ca9d5c06c118e123b25f551f5dcf1ff625f3458414d2 |
| PASS | mysql | row_doc_version | - | 1 | 1 |
| PASS | mysql | row_pipeline_version | - | c1.i1.p2.e1 | c1.i1.p2.e1 |
| PASS | mysql | row_bundle | - | videos | videos |
| PASS | mysql | row_entity_type | - | node | node |
| PASS | mysql | row_changed_mark | - | 1787806306 | 1787806306 |
| PASS | mysql | row_title | - | Celebrating the Clean Kilowatt: Akshay Urja Diwas | Celebrating the Clean Kilowatt: Akshay Urja Diwas |
| PASS | mysql | row_url | - | https://teriin.org/video/celebrating-clean-kilowatt-akshay-urja-diwas | https://teriin.org/video/celebrating-clean-kilowatt-akshay-urja-diwas |
| PASS | mysql | row_effective_start_date | - | 2026-08-27T04:49:55+00:00 | 2026-08-27 04:49:55 |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 09:50:12 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | - | - |
| PASS | mysql | tag_facet_rows | - | ['Clean energy', 'Energy transitions', 'Renewable energy'] | ['Clean energy', 'Energy transitions', 'Renewable energy'] |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 1, 'chunks_cached': 0, 'mentions': 1, 'entities_auto': 0, 'enti… | - | {'document_id': 'f7647c9c-77ad-498d-9d90-38ab1cc0c4b0', 'doc_version'… |
