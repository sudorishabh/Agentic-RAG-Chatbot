...
Run `20260908-121447` started 2026-09-08T12:14:47+00:00 finished 2026-09-08T12:20:28+00:00 · pipeline version `c1.i1.p2.e1` · results in `D:\OneDrive - The Energy and Resources Institute\Desktop\My_Files\Projects\Agentic-RAG-Chatbot\reports\e2e_ingest_audit\run-30docs-postfix`
...
- wall clock for `ingest_drupal`: 266.7s
...
- graph projection: version `graph-project-v1:20260908T122010:6da30fbb` nodes `{'Alias': 2793, 'Entity': 1726, 'Organization': 524, 'Person': 131, 'Predicate': 7, 'Project': 1071}` relationships `{'HAS_ALIAS': 2793}` skipped `{}`
...
- Neo4j: `{'reachable': True, 'node_labels': {'Alias': 2793, 'Entity': 1726, 'Organization': 524, 'Person': 131, 'Predicate': 7, 'Project': 1071}, 'relationship_types': {'HAS_ALIAS': 2793}, 'current_state_edges': 0, 'projection_versions': {'graph-project-v1:20260908T122010:6da30fbb': 4519}}`
- MySQL row counts:
...
| e2e_audit_documents_assertion_rejection | 15 |
...
| 6 | pdf | page | indexed | TERI Alumni Association | 2020-01-01 | document_text | 98 | 431 | 529 | 0 | skipped | 0 | 06_pdf_page_inbody_019c7e59163edfbb3535b05744ff6949b |
| 7 | pdf | page | indexed | TERI Alumni Association | 2022-01-01 | document_text | 69 | 294 | 363 | 0 | skipped | 0 | 07_pdf_page_inbody_0a7c343146247d17ae9ebdffa512fb4a3 |
...
- mysql: documents=1, ·entity_mention=104, ·assertion_rejection=2, ·knowledge_run=1, ·attachment=3, ·entity_resolution_decision=104, ·entity_extraction=23, e2e_audit_ingest_log=1, ·entity (referenced)=1
- knowledge: ok · mentions 104 · resolved auto/prov/amb/unres 2/0/20/82 · claims built/staged/rejected 2/0/2 · projection skipped (0 edges)
- neo4j: document stub no · claim nodes 0 · current edges 0
...
- mysql: documents=1, ·date_decision=1, ·entity_mention=1673, ·assertion_rejection=4, ·knowledge_run=1, ·attachment (as file)=1, ·entity_resolution_decision=1673, ·entity_extraction=431, e2e_audit_ingest_log=1, ·entity (referenced)=7
- knowledge: ok · mentions 1673 · resolved auto/prov/amb/unres 29/0/50/1594 · claims built/staged/rejected 4/0/4 · projection skipped (0 edges)
- knowledge notes: ["model calls stopped at 8; the document's remaining chunks were not examined"]
- neo4j: document stub no · claim nodes 0 · current edges 0
- checks: 87 pass / 0 fail · folder `documents/06_pdf_page_inbody_019c7e59163edfbb3535b05744ff6949b/`
...
- mysql: documents=1, ·date_decision=1, ·entity_mention=882, ·assertion_rejection=2, ·knowledge_run=1, ·attachment (as file)=1, ·entity_resolution_decision=882, ·entity_extraction=294, e2e_audit_ingest_log=1, ·entity (referenced)=6
- knowledge: ok · mentions 882 · resolved auto/prov/amb/unres 11/0/89/782 · claims built/staged/rejected 2/0/2 · projection skipped (0 edges)
- knowledge notes: ["model calls stopped at 8; the document's remaining chunks were not examined"]
- neo4j: document stub no · claim nodes 0 · current edges 0
- checks: 87 pass / 0 fail · folder `documents/07_pdf_page_inbody_0a7c343146247d17ae9ebdffa512fb4a3/`
...
- chunks: 1 parents / 4 children · Qdrant points 5
- mysql: documents=1, ·tag=3, ·theme=1, ·date_decision=1, ·entity_mention=6, ·assertion_rejection=1, ·knowledge_run=1, ·entity_resolution_decision=6, ·entity_extraction=4, e2e_audit_ingest_log=1, ·entity (referenced)=2
- knowledge: ok · mentions 6 · resolved auto/prov/amb/unres 6/0/0/0 · claims built/staged/rejected 1/0/1 · projection skipped (0 edges)
- neo4j: document stub no · claim nodes 0 · current edges 0
