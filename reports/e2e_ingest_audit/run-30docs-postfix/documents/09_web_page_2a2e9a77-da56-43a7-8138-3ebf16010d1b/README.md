...
- handled in 2.293s (build 0.0s, extract Nones, chunk 0.004s, embed+upsert 0.411s, knowledge 1.847s)
...
### 8. Knowledge stage
- status **ok** in 1.83s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:19:14 |
