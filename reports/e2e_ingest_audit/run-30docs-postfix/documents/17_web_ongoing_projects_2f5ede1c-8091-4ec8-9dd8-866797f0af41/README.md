...
- handled in 3.479s (build 0.0s, extract Nones, chunk 0.003s, embed+upsert 0.416s, knowledge 3.004s)
...
### 8. Knowledge stage
- status **ok** in 3.0s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:19:30 |
