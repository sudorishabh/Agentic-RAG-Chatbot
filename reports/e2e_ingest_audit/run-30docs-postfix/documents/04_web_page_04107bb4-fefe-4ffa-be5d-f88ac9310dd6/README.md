...
- handled in 9.213s (build 0.0s, extract Nones, chunk 0.057s, embed+upsert 1.061s, knowledge 8.063s)
...
### 8. Knowledge stage
- status **ok** in 8.06s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 23, 'chunks_cached': 0, 'mentions': 104, 'entities_auto': 2, 'entities_provisional': 0, 'entities_ambiguous': 20, 'entities_unresolved': 82, 'claims_built': 2, 'claims_staged': 0, 'claims_rejected': 2, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'llm_calls': 2, 'llm_failures': 0, 'llm': 2, 'unknown_predicates': 0, 'built': 2} · notes [] · errors []
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:15:49 |
