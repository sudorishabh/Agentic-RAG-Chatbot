# 27_web_press_release_50892144-b9bd-4cc2-8661-4ae65b2921a3
...
- handled in 12.476s (build 0.0s, extract Nones, chunk 0.012s, embed+upsert 0.659s, knowledge 11.754s)
...
### 8. Knowledge stage
- status **ok** in 11.75s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 4, 'chunks_cached': 0, 'mentions': 6, 'entities_auto': 6, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 0, 'claims_built': 1, 'claims_staged': 0, 'claims_rejected': 1, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'llm_calls': 2, 'llm_failures': 0, 'llm': 1, 'unknown_predicates': 0, 'built': 1} · notes [] · errors []
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:19:45 |
