...
- handled in 6.362s (build 0.0s, extract Nones, chunk 0.009s, embed+upsert 1.997s, knowledge 4.326s)
...
### 8. Knowledge stage
- status **ok** in 4.32s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:19:59 |
