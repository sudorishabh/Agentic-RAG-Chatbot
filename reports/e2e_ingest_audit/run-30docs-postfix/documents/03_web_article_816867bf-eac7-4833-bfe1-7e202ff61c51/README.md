...
- handled in 0.899s (build 0.0s, extract Nones, chunk 0.028s, embed+upsert 0.747s, knowledge 0.091s)
...
### 8. Knowledge stage
- status **ok** in 0.09s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:15:48 |
