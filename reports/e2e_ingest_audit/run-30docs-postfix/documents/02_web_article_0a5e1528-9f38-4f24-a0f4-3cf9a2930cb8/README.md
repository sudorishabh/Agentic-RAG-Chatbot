# 02_web_article_0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8

**website** · bundle `article` · outcome **indexed**

- document_id: `0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8`
- title: When Risk Stops Looking Normal: Lessons from the Nepal Floods
- source_key: https://teriin.org/article/when-risk-stops-looking-normal-lessons-nepal-floods
- handled in 0.731s (build 0.0s, extract Nones, chunk 0.014s, embed+upsert 0.658s, knowledge 0.028s)
...
- JSON:API `node/article` uuid `0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8` · nid 13363 · created 2026-08-31T09:18:16+00:00 · changed 2026-08-31T09:19:47+00:00
- change detection: status **new** · fingerprint `2026-08-31T09:19:47+00:00` · changed_mark 1788167987 · prior: False

### 2. Extraction
- HTML→text: body 7019 chars from 1 rich-text field(s); 0 PDF link(s) discovered ([])

### 3. Canonical document
- sections 1 · body chars 7019 · content_hash `121d1735f6fbf19f647385ff6377ea6d975099720087c378d94220e16731437b` · doc_version 1
- authors ['Ms Shiren Pandita'] · tags [] · categories ['Sustainable Habitat']
- entity_refs 7 · file_links []
- extra {'bundle': 'article', 'nid': 13363, 'changed': '2026-08-31T09:19:47+00:00'}

### 4. Dates
- effective_start_date **2026-08-31T09:18:16+00:00** (precision day, source created) · effective_end_date None (precision None)
...
### 5. Chunks
- 0 parent(s), 4 child(ren) · child tokens min/avg/max 184/318/447 · section types ['None']

### 6. Qdrant
- collection `e2e_audit_documents` · points for this document: 4 · indexer reported 4
- delete_document calls: [{'document_id': '0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8', 'keep_ids': 4}]
...
- counts {'chunks_seen': 4, 'chunks_cached': 0, 'mentions': 0, 'entities_auto': 0, 'entities_provisional': 0, 'entities_ambiguous': 0, 'entities_unresolved': 0, 'claims_built': 0, 'claims_staged': 0, 'claims_rejected': 0, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `resolution`: ran · counts {'auto': 0, 'provisional': 0, 'ambiguous': 0, 'unresolved': 0, 'cache_recorded': 4} · notes [] · errors []
...
| PASS | canonical | title_equals_node_title | - | When Risk Stops Looking Normal: Lessons from the Nepal Floods | When Risk Stops Looking Normal: Lessons from the Nepal Floods |
| PASS | canonical | body_is_single_section | Website body becomes one section. | 7019 | 7019 |
| PASS | canonical | raw_meta_equals_record_metadata | - | - | - |
| PASS | canonical | article_uuid_is_node_uuid | - | 0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8 | 0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8 |
| PASS | canonical | file_links_equal_record_files | - | - | - |
| PASS | canonical | extra_carries_bundle_nid_changed | - | - | {'bundle': 'article', 'nid': 13363, 'changed': '2026-08-31T09:19:47+0… |
| PASS | canonical | facets_match_drupal_facets_rule | - | {'categories': ['Sustainable Habitat'], 'tags': [], 'authors': ['Ms S… | {'categories': ['Sustainable Habitat'], 'tags': [], 'authors': ['Ms S… |
| PASS | canonical | content_hash_is_sha256_of_body_text | - | - | 121d1735f6fbf19f647385ff6377ea6d975099720087c378d94220e16731437b |
| PASS | canonical | body_text_non_empty | - | >0 chars | 7019 |
| PASS | dates | effective_start_date_present | Undated documents are excluded from date filters (pipeline warns). | a date | 2026-08-31T09:18:16+00:00 |
...
| PASS | dates | canonical_date_equals_evidence_value | - | 2026-08-31T09:18:16+00:00 | 2026-08-31T09:18:16+00:00 |
...
| PASS | chunks | chunks_produced | - | >0 children | {'parents': 0, 'children': 4} |
...
| PASS | chunks | children_within_token_limit | child_max_tokens=480 | 480 | {'max_child_tokens': 447, 'over': []} |
...
| PASS | chunks | source_lines_covered_by_chunks | 100.000% of 33 source lines appear verbatim in some chunk | >=98% | {'coverage': 1.0, 'missing_sample': []} |
...
| PASS | qdrant | points_carry_effective_start_date | - | 2026-08-31T09:18:16+00:00 | ['2026-08-31T09:18:16+00:00'] |
...
| PASS | qdrant | swap_deleted_with_keep_ids | delete_document(id, keep_ids=<new chunk ids>) ran after the upsert. | 4 | [{'document_id': '0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8', 'keep_ids': … |
| PASS | mysql | state_row_exists | - | - | - |
| PASS | mysql | row_source_type | - | website | website |
| PASS | mysql | row_source_key | - | https://teriin.org/article/when-risk-stops-looking-normal-lessons-nep… | https://teriin.org/article/when-risk-stops-looking-normal-lessons-nep… |
| PASS | mysql | row_fingerprint | - | 2026-08-31T09:19:47+00:00 | 2026-08-31T09:19:47+00:00 |
| PASS | mysql | row_content_hash | - | 121d1735f6fbf19f647385ff6377ea6d975099720087c378d94220e16731437b | 121d1735f6fbf19f647385ff6377ea6d975099720087c378d94220e16731437b |
...
| PASS | mysql | row_changed_mark | - | 1788167987 | 1788167987 |
| PASS | mysql | row_title | - | When Risk Stops Looking Normal: Lessons from the Nepal Floods | When Risk Stops Looking Normal: Lessons from the Nepal Floods |
| PASS | mysql | row_url | - | https://teriin.org/article/when-risk-stops-looking-normal-lessons-nep… | https://teriin.org/article/when-risk-stops-looking-normal-lessons-nep… |
| PASS | mysql | row_effective_start_date | - | 2026-08-31T09:18:16+00:00 | 2026-08-31 09:18:16 |
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:15:47 |
| PASS | mysql | row_raw_meta_equals_canonical | - | - | - |
| PASS | mysql | author_facet_rows | - | ['Ms Shiren Pandita'] | ['Ms Shiren Pandita'] |
...
| INFO | knowledge | stage_report | status=ok {'chunks_seen': 4, 'chunks_cached': 0, 'mentions': 0, 'entities_auto': 0, 'enti… | - | {'document_id': '0a5e1528-9f38-4f24-a0f4-3cf9a2930cb8', 'doc_version'… |
