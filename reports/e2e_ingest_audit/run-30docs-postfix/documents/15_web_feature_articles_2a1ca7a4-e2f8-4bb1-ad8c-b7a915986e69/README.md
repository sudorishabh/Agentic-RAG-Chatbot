...
- handled in 3.672s (build 0.0s, extract Nones, chunk 0.001s, embed+upsert 0.396s, knowledge 3.246s)
...
### 8. Knowledge stage
- status **ok** in 3.24s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:19:25 |
