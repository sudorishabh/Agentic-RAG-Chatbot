...
- handled in 3.145s (build 0.0s, extract Nones, chunk 0.005s, embed+upsert 0.398s, knowledge 2.693s)
...
### 8. Knowledge stage
- status **ok** in 2.69s · knowledge_version `kv1:57e6b192246add32`
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:19:35 |
