...
- handled in 61.432s (build 15.169s, extract 14.624s, chunk 1.398s, embed+upsert 16.215s, knowledge 28.608s)
...
- `e2e_audit_documents_assertion_rejection`: 2 row(s)
...
### 8. Knowledge stage
- status **ok** in 28.6s · knowledge_version `kv1:57e6b192246add32`
- counts {'chunks_seen': 294, 'chunks_cached': 0, 'mentions': 882, 'entities_auto': 11, 'entities_provisional': 0, 'entities_ambiguous': 89, 'entities_unresolved': 782, 'claims_built': 2, 'claims_staged': 0, 'claims_rejected': 2, 'claims_retracted': 0, 'pending_predicates': 0, 'conflicts_disputed': 0, 'conflicts_superseded': 0}
- projection {'status': 'skipped', 'version': None, 'edges': 0}
  ...
  - stage `claims`: ran · counts {'llm_calls': 8, 'llm_failures': 0, 'llm': 2, 'unknown_predicates': 0, 'built': 2} · notes ["model calls stopped at 8; the document's remaining chunks were not examined"] · errors []
  - stage `validate`: ran · counts {'accepted': 0, 'rejected': 2, 'rejected_missing_object_entity': 2} · notes [] · errors []
  - stage `persist`: ran · counts {'accepted': 0, 'pending_predicates': 0, 'rejections_recorded': 2} · notes [] · errors []
...
| PASS | mysql | row_indexed_at_set | - | not null | 2026-09-08 12:18:42 |
...
| PASS | knowledge | rejection_rows_equal_report | - | 2 | 2 |
