...
## Page 9 · via `text` · 1 table(s)

Financial Cost of Power Generation 

| Plant Locations | Fuel Options |  |  |  |
| --- | --- | --- | --- | --- |
...
“If the target were between 450- 550ppm CO2e, then the social cost of carbon would 
...
OECD countries – particularly India and China 
China – became a net importer of coal in 2009 
This will increase the competition among importing countries

## Page 23 · via `text` · 1 table(s)

Global Coal Markets: Import Constraints for 
India 

Changes 
in 
...
Natural Gas 
• LNG terminals 
• Regasification facilities - FSRUs 
Import infrastructure 
