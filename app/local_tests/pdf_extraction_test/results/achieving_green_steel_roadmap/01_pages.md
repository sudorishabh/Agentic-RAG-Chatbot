...
Figure 1: A stylized vector illustration of a steel or metal foundry showing silhouetted workers pouring and spreading glowing molten metal and rolling it into coils against a backdrop of industrial structures (cranes, chimneys, vats); bright yellows and oranges highlight the heated metal and work area.

Figure 2: Roadmap-style infographic showing a curved road timeline of policy and technology milestones for decarbonizing India’s steel sector, with labeled points such as "National Steel Policy, 2017", "Steel Scrap Recycling Policy, 2019", "Green steel vision" and target years 2020, 2030 and 2070. Key actions depicted include R&D and demonstration plants, green product standards, increased scrap utilisation, energy-efficiency improvements, retirement of high-emission capacity and commercial-scale facilities aimed at a net-zero iron and steel sector.

Figure 3: Combined header graphic showing organizational logos and branding: the stylized "teri" logo with the tagline "Creating Innovative Solutions for a Sustainable Future" at left, central text "The Energy and Resources Institute," and a circular mountain/arrow logo labeled "ENERGY TRANSITIONS COMMISSION INDIA" at right. The figure is an institutional branding/header for TERI and the Energy Transitions Commission India.
...
Figure 4: Figure 1: Route-wise crude steel production share, 2020-21 — Donut chart showing percentage distribution among three categories: BOF (blue) 45%, EAF (yellow) 28%, and EIF (orange) 27%, with BOF as the largest share.

Source: (MoS, 2021a)

## Page 20 · via `text` · 0 table(s), 0 image(s)

| 8 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
below 100 Mt in 2020-212
 following the Covid-19 pandemic. However, the cumulative production of crude 
...
ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA | 9 |
...
| 10 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
500
600
0 10,000 20,00030,000 40,000 50,000
...
Figure 5: Figure 6: Digitalistion trends over the 2020s — Radial diagram with a central orange node and eight labeled spokes/icons representing emerging technologies: Internet of things, Augmented reality, Virtual reality, Blockchain, Artificial intelligence, 3D printing, Drones, and Robots. The figure visualizes these technologies as interconnected core areas in a single ecosystem.
...
Figure 6: Figure 7: Green steel projects pipeline — Horizontal bar/timeline chart showing major steel companies (y-axis: Baowu, ArcelorMittal, HBIS, Nippon Steel, POSCO, Tata Steel, JFE, US Steel, ThyssenKrupp, Tenaris) with left-side bars for total steel produced (MN tonnes p.a.) and colored project tiles on a timeline labeled by launch year (2017–2030 and TBC). The colored tiles indicate project scale (red = full scale, blue = pilots, purple = demonstration plant, yellow = R&D partnership) and show that most firms have multiple planned projects across 2021–2030 with many dates still TBC.
...
| 16 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
2.1 Overview
...
| 18 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
18
2.4 Employment
...
## Page 32 · via `text` · 0 table(s), 0 image(s)

| 20 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA | 21 |
-31%
0%
31%
63%
94%
125%
2007-082009-10 2011-122013-14 2015-162017-18 2019-20
EBITDA/Net Sales (%)
JSW Tata Steel Ltd. Steel Authority of India Ltd.
Jindal Steel & Power Ltd. Jindal Stainless Ltd. Average
...
the EBITDA3
 margin for the steel sector. Figure 9 shows this decline for the five largest producers in India, 
...
use per capita to 150 kg. Under the Resource efficiency4
 scenario, steel use per capita is similar over this 
...
| 22 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
DRI with 
CCUS
4 There have been no comprehensive 
studies on applying CCUS technology 
to coal-based rotary kilns for sponge 
iron production but similarity to 
natural gas DRI suggests around 90% 
reduction may be possible.
Coal-based DRI units tend to have smaller 
capacities potentially making the fixed and 
operating costs of CCUS excessively large. 
Given the early stage of development of 
the necessary technology, seems to be 
unsuitable.
Natural gas 
DRI with 
CCUS
9 Currently operating plants have 
shown that around 90% reduction is 
possible. 
Limited availability of natural gas at 
competitive prices has already restricted 
the growth of natural gas-based capacity in 
India. Additional costs of CCUS would make 
these plants less competitive.
Smelting 
reduction 
with CCUS
7 Smelting reduction processes 
alone can reduce emissions 
by approximately 20% versus 
conventional BF-BOF. The addition 
of CCUS can potentially reduce 
emissions by 80% (Tata Steel, 2020).
Tata Steel have developed a pilot smelting 
reduction plant in the Netherlands 
(HIsarna) and considering to install a larger 
demonstration plant in India. The CAPEX
...
that H2
 injection into BFs can only ever 
be a transition technology to deeper 
decarbonisation. 
H2
 DRI 7 Emissions reduction potential 
depends on the share of H2
 and 
whether the H2
 is from low carbon 
...
with residual emissions from carbon 
sources for steelmaking, graphite 
electrodes and limestone.
Low cost renewable electricity provides a 
cost-effective route for green H2
 production. 
Whilst a high H2
 blend plant does not currently 
exist, technology is well understood. 
H2
 plasma 
reduction 
4 If produced from low carbon 
electricity, there is the potential for 
>90% emissions reduction.
Technology is still at an early stage, although 
trials have been carried out in both Europe 
and in India (Institute of Minerals and 
Materials Technology, IMMT). Timeline for 
commercial scale is unknown.
Direct electrification
Electrolysis 4 If produced from low carbon 
electricity, there is the potential for 
>90% emissions reduction. 
Current research projects are still at 
...
| 24 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
around suitability for the Indian context due to availability of CO2
 stores.
...
1.65
49
Blast furnace COREX Sponge iron
57
49
42
BOF EAF EIF
...
ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA | 27 |
...
30
35
2021-252026-30 2031-2035 2036-20402041-2045 2046-2050
Blast furnace capacity (Mt)
...
technology assessments for the Indian and global steel sector,5
 which will inform the conclusions in this 
section. 
...
route (Figure 43). However, with the addition of CCUS infrastructure at cost of around $20/tCO2
 (IEA, 2020) 
...
500
600
BF-BOF Coal DR-EAF NG DR-EAF SR-BOF
CCUS
H2 DR-EAFMOE-EAF
Cost of production ($/t)
CAPEX Fixed OPEX Fuel Raw materials CCUS Range
...
Figure 17: Costs of production - H2
-DR vs SR-BOF with CCUS
 Source: TERI analysis based on (IEA, 2019; Hall, Spencer, & Kumar, 2020; BNEF, 2020)
Note: tCO2
 refers to the cost of carbon capture and storage, not to carbon price. 
0
100
200
300
...
ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA | 31 |
...
Steel production (Mt)
BF-BOF Coal DR-EAF NG DR-EAF Scrap EAF
BF-BOF CCUS MOE H2 DR-EAF

## Page 44 · via `text` · 0 table(s), 0 image(s)

| 32 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
located close to cost-effective CO2
 storage, who are entering their 2nd or 3rd relining campaign (see Section 
...
ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA | 33 |
...
production6
. For the NZ2070 scenario, the challenge is already extreme, with production increasing 10-fold 
...
NZ2070 NZ2050
6 Electricity consumption assumptions = 650 kWh for EAF, 3.4 MWh for MOE and 2.9 MWh for H2
DR
...
which reduces the amount of raw material required for primary steel production, resulting in positive knock￾on effects for energy and emissions. 
...
Scrap Coking coal Non-coking coal Limestone Iron ore
0
1
2
3
...
Source: TERI analysis based on data from BEE 2018; MoS 2017. Assuming an emissions intensity of electricity of 700gCO2
/kWh.

## Page 50 · via `text` · 0 table(s), 0 image(s)

| 38 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
5.5 Promote technical research & development and set￾up demonstration plants
...
## Page 52 · via `text` · 0 table(s), 0 image(s)
...
route
Smelting reduction
facility e.g. Hlsarna
Natural gas / Syngas
direct reduction
2070
Increase capture rate to >90%, making
...
## Page 53 · via `text` · 0 table(s), 0 image(s)

ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA | 41 |
...
is likely to be insufficient given limited domestic resources. As renewable electricity projects become ‘self￾financing’ in India, thanks in large part to a dramatic reduction in technology costs, as well as a growing 
...
## Page 54 · via `text` · 0 table(s), 0 image(s)

| 42 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDIA
...
steel. Retrieved from https://corporate.arcelormittal.com/media/press-releases/arcelormittal-launches￾xcarb-signalling-its-commitment-to-producing-carbon-neutral-steel#:~:text=ArcelorMittal%20launches%20
XCarb%E2%84%A2%2C%20signalling%20its%20commitment%20to%20producing%20carbo
ArcelorMittal. Hydrogen-based steelmaking to begin in Hamburg. Retrieved from https://corporate.arcelormittal.
com/media/case-studies/hydrogen-based-steelmaking-to-begin-in-hamburg
...
Business Standard. (2020). Steel ministry is looking at $70-bn investment in eastern region: Pradhan. Retrieved from 
https://www.business-standard.com/article/pti-stories/steel-ministry-looks-at-usd-70bn-investments-in-eastern￾region-120011100666_1.html
CIO&Leader. (2017). How Jindal Steel and Power is using IoT to future proof its busines. Retrieved from CIO&Leader: 
https://www.cioandleader.com/article/2017/06/05/how-jindal-steel-and-power-using-iot-future-proof-its-business
...
ets_en
EY. (2020). Securing a robust and sustainable future for the Indian Steel industry. Retrieved from https://assets.
ey.com/content/dam/ey-sites/ey-com/en_in/topics/mining-metals/2020/09/securing-a-robust-and-sustainable￾future-for-the-indian-steel-industry.pdf
Hall, W., Spencer, T., & Kumar, S. (2020). Towards a Low Carbon Steel Sector: An overview of the changing market, 
technology and policy context for Indian steel. Retrieved from teriin.org.
Hall, W., Spencer, T., Renjith, G., & Dayal, S. (2020). The Potential Role of Hydrogen in India: A pathway for scaling￾up low carbon hydrogen across the economy. The Energy and Resources Institute (TERI). New Delhi: The Energy and 
...
| 46 | ACHIEVING GREEN STEEL: ROADMAP TO A NET ZERO STEEL SECTOR IN INDI