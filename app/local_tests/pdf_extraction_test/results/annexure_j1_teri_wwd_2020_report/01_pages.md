# Pages — Annexure_J1_ TERI_WWD-2020_Report.pdf

## Page 1 · via `docling` · 0 table(s), 7 image(s)

Figure 1: Logo image of the United Nations Environment Programme, featuring a light-blue "UN" with the UN laurel emblem to the right, the word "environment" below, and the text "United Nations Environment Programme" at the bottom.

Figure 2: Logo featuring bold text "Counter MEASURE" with the tagline "FOR PLASTIC FREE RIVERS" and a stylized winding river graphic to the right. It serves as branding for a campaign/initiative promoting plastic-free rivers.

Figure 3: A colored municipal emblem/logo: an ornate shield quartered into four panels depicting industrial buildings, a train, ships and a waterfront figure, surrounded by a decorative border and banners with Devanagari text including "नवी मुंबई महानगरपालिका" and the founding year.

Figure 4: Logo image showing the word "Ramsar" in a white serif font over a teal gradient background with three white curved wave lines above it, indicating the Ramsar branding for wetlands conservation.

Figure 5: Logo image of the National Service Scheme: a circular emblem with a red stylized wheel at the center surrounded by a blue ring bearing Hindi text "राष्ट्रीय सेवा योजना" at the top and English "NATIONAL SERVICE SCHEME" at the bottom.

Figure 6: Logo-style illustration of a green plant sprout emerging from a blue plastic bottle placed over a brown segmented circular shape, with the caption "RETHINK PLASTIC" beneath. The image conveys an environmental/sustainability message about rethinking plastic use.

## Save Wetlands from

## Report on Plastic Litter

A celebration of

World Wetlands Day- February 2, 2020 Location : Veer Savarkar Udyan, Sagar Vihar; Vashi, Navi Mumbai

Figure 7: Logo image showing the lowercase word "teri" in bold red with a red dot over the "i" and an orange-yellow diagonal-striped drop-shadow beneath the letters.

## Page 2 · via `docling` · 0 table(s), 2 image(s)

Figure 8: A colored municipal emblem/seal divided into four quadrants depicting industrial buildings and a ship, a train with high-rise buildings, harbor boats, and a farmer with livestock; the crest includes Marathi/Hindi text "नवी मुंबई महानगरपालिका" and the establishment year "1991" on a ribbon beneath, symbolizing the sectors of Navi Mumbai.

## Special Message Shri Annasaheb Misal

## Commissioner, Navi Mumbai Municipal Corporation (NMMC)

Figure 9: Photograph of a seated person wearing a light pink button-down shirt at an office desk, hands clasped on the table and the face deliberately blurred. The office background shows a mesh chair, paperwork, and a framed certificate, indicating an anonymized professional portrait.

Navi Mumbai Municipal Corporation (NMMC), one of the most progressive ULB's in India has always focused on the environmental conservation and sustainable development of the city. The measures taken by NMMC have led to Navi Mumbai being ranked 7 th in India under Swachha Bharat Abhiyan (SBA) in 2019. Additionally, Navi Mumbai has been bestowed with rich natural vegetation, mangroves and wetlands which protect the city from natural calamities like floods, provides carbon sink and contributes to the quality of life in the city. However, today, like most other cities in the world, plastic pollution is a growing concern in Navi Mumbai as well, directly impacting its ecosystems and thus needing conservation measures.
...
## Page 3 · via `docling` · 0 table(s), 2 image(s)

Figure 10: Logo-style emblem of the University of Mumbai showing a shield containing a tall tower, a ship on the left, industrial gears and smokestack on the right, and an open book labeled "1857"; "University of Mumbai" appears above and a ribbon with a Marathi motto is below.

## Special Message Prof. Suhas Pednekar , Vice Chancellor, University of Mumbai

Figure 11: Photograph: a head-and-shoulders portrait of a person wearing a dark, buttoned jacket against a white background with the face blurred. The image shows formal attire and no visible labels or axes.
...
With our University as an official partner of TERIUNEP's ''Promotion of Counter-Measures against Marine Plastic Litter in Southeast Asia and India'' project, its' been a great opportunity for TERI, UNEP and the University of Mumbai to come together and collaborate to address the issue of plastic pollution. Our NSS staff and volunteers have participated in various awareness activities organized by TERI under 'Rethink Plastic' campaign, including World Wetlands Day (WWD) -2020. I appreciate TERIUNEP's efforts on emphasizing the issue of plastic pollution in each and every program and grateful for giving NSS students the opportunity to be a part of the campaign. It's been a great learning experience for our students and it helped sensitize them to the perils of incorrect plastic disposal as well as significance of protecting mangrove ecosystem.
...
## Page 4 · via `docling` · 0 table(s), 2 image(s)

Figure 12: Logo of the United Nations Environment Programme: a blue UN emblem and large "UN" text above the word "environment" with the caption "United Nations Environment Programme" beneath.

## Special Message Mr. Atul Bagai

## Country Head- India Office, United Nations Environment Programme (UNEP)

Figure 13: Photograph of a seated older person with their face blurred, wearing a dark patterned garment with orange trim; background shows other partially visible standing figures. The image is a portrait-style crop emphasizing the subject's clothing and posture rather than facial details.
...
Figure 14: A stylized brand logo showing the word "teri" in bold red lowercase letters with a red dot above the "i", set against a yellow-and-orange diagonal striped shadow/underlay forming an angled base. There are no axes or data labels — the image is a colorful typographic logo.
...
Figure 15: Photograph portrait of a person wearing a dark suit, white shirt and red patterned tie, standing outdoors with arms crossed. The subject’s face is blurred/obscured, indicating anonymity or redaction.
...
## Page 6 · via `docling` · 1 table(s), 0 image(s)
...
## Page 7 · via `docling` · 1 table(s), 0 image(s)
...
| 10.15 AM-10.30 AM                 | Welcomeand Introduction about projectand the event-TERI and UNEP                                                 |
...
| 12.05 PM-1.00 PM                  | Messageson Wetland conservation through art (Rangoli and Posters)                                                |
| 12.05 PM-1.00 PM                  | Pledge against single use plastic and Perception survey                                                          |
| 12.05 PM-1.00 PM                  | Plant a Sapling in waste plastic bottle                                                                          |
...
## Page 9 · via `docling` · 0 table(s), 1 image(s)

## Dignitaries on Dais

Figure 16: (From L to R): Smt. Shaila Sam, Media and Communication Specialist, UNEP ; Shri. Lovish Ahuja, Vice President, Governmental Affairs -India, TOMRA ; Smt. Saloni Goel, Consultant, Plastic Pollution Programme, UNEP ; Shri. G.S. Gill (IAS), Distinguished Advisor, TERI-WRC ; Shri. Annasaheb Misal, IAS, Commissioner, NMMC and Shri. J.S.Saharia, (IAS), Former Chief Secretary, Government of Maharashtra (GoM) — Photograph of six panelists seated behind a long white-draped table on a red stage beneath a banner reading "World Wetlands Day - 2020" with the header "Promotion of Countermeasures Against Marine Plastic Litter in Southeast Asia and India" and "RETHINK PLASTIC." The image documents an event panel/ceremony focused on addressing marine plastic pollution.

## Page 10 · via `docling` · 0 table(s), 1 image(s)

## a) Welcome and Event Introduction

Figure 17: Dr. Anjali Parasnis — Photograph of a person speaking at a lectern: a red-draped podium with a gooseneck microphone and a person in a patterned sari gesturing while giving a speech, with the face blurred.
...
Further, she also explained about the importance of mangroves for coastal cities like Mumbai and Navi Mumbai and emphasized on their better management and conservation.

## Page 11 · via `docling` · 0 table(s), 2 image(s)

## Program Inauguration World Wetlands Day 2020

Figure 18: Photograph of three men standing behind a table at an outdoor event, with two small saplings in plastic bottles and several nameplates visible on the table. The scene appears to depict a ceremonial planting or seedling demonstration.

Figure 19: Photograph of an outdoor event where four people unveil a large dolphin artwork made from plastic bottle caps and other plastic litter; a banner behind them reads "Promotion of Countermeasures Against Marine Plastic Litter in Southeast Asia and India" and "World Wetlands Day‑2020." The image highlights an awareness campaign against marine plastic pollution using recycled plastic as art.

Hon'ble Chief Guest planting the Native Sapling ( left ) and unveiling the collage made from Plastic waste ( right )

## Page 12 · via `docling` · 0 table(s), 2 image(s)

## Welcoming the Dignitaries with Native Tree Saplings

Figure 20: Mr. Lovish Ahuja, Vice President, Governmental Affairs, India, TOMRA — Photograph of a ceremonial handover showing a man and a woman exchanging a potted sapling at an outdoor event, with a red backdrop and seated officials behind a table with visible nameplates; the image highlights a symbolic tree-planting or plant-gift presentation.

Figure 21: Mr. J.S. Saharia, Former Chief Secretary, GoM — Photograph of two people outdoors exchanging a small potted sapling—an older man in a striped shirt handing the plant to a woman in black over a table with another sapling and papers. The scene appears to depict a tree-planting or sapling-distribution event.
...
NMMC
• The Commissioner, NMMC appreciated the TERI￾UNEP initiative to counter marine plastic pollution.
...
• She urged the citizens to stop using single use plastics and switch to eco￾friendly alternatives and encouraged the young participants to actively act
...
## Page 17 · via `text` · 0 table(s), 0 image(s)
...
inorganic nutrients and thus, act as
a
breeding ground and nursery for
various marine organisms
.
However
, plastic litter in mangroves is
...
## Page 34 · via `docling` · 0 table(s), 2 image(s)

Figure 22: Photo of a hand-drawn poster titled "SAVE OUR WETLANDS" showing a cross-section of a wetland with healthy trees and fish on the left and pollution (trash, oil drops, debris) on the right; colored pencils lie nearby. The poster includes logos for UN Environment, TERI and Ramsar and a "Name of the Participant(s)" box.
...
Figure 23: Hand-drawn poster-style illustration of a coastal scene showing waves, stilt houses, stick-figure people and a single mangrove tree, with the handwritten labels "Save Mangroves" at the top and "Mangroves will save you!!!" at the bottom. The image communicates that mangroves protect coastal communities from waves.

## Page 35 · via `docling` · 0 table(s), 1 image(s)

## c) Pledge and Perception survey

Figure 24: Photograph of several people gathered at a long outdoor table signing forms; sheets of paper, pens and folders are visible, indicating a registration or sign-in process.

## Perception Survey- Rationale

- Perception of individuals is very important to understand the behavior, practices and awareness of the citizens as well as to carve out a way forward .

- The perception survey on ' Plastic Use and Management ' was designed to assess the opinions of individuals regarding plastic use, management of plastic waste and awareness about alternatives to plastic and impacts of plastic pollution on health and environment.
...
- Single use plastic is a rising global concern. Invented for the sake of convenience, today it is an environmental hazard.

- In order to reduce dependence on single use plastics and promote use of alternatives, the participants were encouraged to take pledge against single use plastic.

## Page 36 · via `docling` · 0 table(s), 3 image(s)

## Special Electronic Interphase to take Pledge and Perception survey

TERI created special electronic interphaseQR Codes to take the pledge and perception Survey which were displayed at the event venue, to reduce paper wastage and keeping in mind the tech savvy young participants .

Figure 25: A black-and-white square QR code (matrix barcode) filling the figure, showing the characteristic three corner position markers and a dense pattern of modules; no labels or axes. The image is meant to be scanned to retrieve the encoded data (e.g., a URL or text).

QR Code to take the Perception Survey QR Code to take the Pledge against Single Use Plastic QR Code of the 'Rethink Plastic' App to register contribution of saplings and waste plastic bottles More than 300 individuals took the Pledge against Single Use Plastics and filled in the Perception survey

Figure 26: A high-contrast black-and-white QR code (matrix barcode) showing the standard finder squares in three corners; it encodes machine-readable data (e.g., a URL or short text) intended for scanning.

Figure 27: A black-and-white QR code (square 2D barcode) showing the typical finder patterns in three corners and a dense grid of data modules. It is a scannable image that encodes information (such as a URL or text) rather than labeled axes or annotations.

## Page 37 · via `docling` · 0 table(s), 1 image(s)
...
Figure 28: Sapling of Indian Almond Tree ( Terminalia catappa ) — Photograph of a young green seedling growing in a cut clear plastic bottle filled with soil, shown against a wooden background; illustrates containerized plant propagation using a recycled bottle.
...
## Page 38 · via `docling` · 0 table(s), 3 image(s)

## Why plant Native saplings?

Figure 29: Photograph of a large, mature banyan/fig-like tree with a wide, spreading canopy, multiple aerial roots and a massive central trunk. The tree stands on a grassy lawn with a small shelter or building visible in the background.

## Banyan ( Ficus benghalensis ) (Vad, Bargad)

- Medicinal properties: leaf, bark, seeds and fig cure disorders like diarrhea, polyuria, dental, diabetes and urine disorders

- Wood : making door panels, boxes
...
Figure 30: Photograph of neem tree branches showing pinnate, serrated leaflets and hanging clusters of small green oval fruits (neem drupes); no axes or labels. The image highlights the foliage and immature fruiting stage of the tree.

## Neem ( Azadirachta indica )

- Medicinal uses: effective for skin infections, intestinal problems, diabetes, malaria,

- Neem oil: pesticide for grain storage
...
Figure 31: Close-up photograph of a tree branch showing multiple heart-shaped green leaves with prominent veins and long pointed/drip tips (characteristic of the peepal/Bodhi tree), with part of the trunk visible at right.
...
- Bark: extraction of reddish dye; cure inflammations and glandular swelling

- Medicinal uses: beneficial for eczema, asthma, blood purification, digestive ailments

## Page 39 · via `docling` · 0 table(s), 1 image(s)
...
Figure 32: Photograph of an outdoor community event showing several people at tables potting young seedlings into upcycled plastic bottles and a bucket; multiple bottle planters filled with soil and small plants are visible. The image documents a hands-on tree-planting or sapling-distribution activity.

30 volunteers participated in this activity

## Page 40 · via `docling` · 0 table(s), 2 image(s)

## e) Display of Cloth Bags - Aapli Pishvi

Figure 33: Photograph of an outdoor market/exhibit table displaying colorful folded fabrics and scarves on a red-draped table with hanging textile samples on a fence behind it, three women standing behind the display and a visible label "5" on the table.

They gave away the cloth bags free of cost to the participants in order to promote the use of cloth carry bags and reducing plastic carry bags A display of cloth carry bags made using old clothes was set up by the representatives of Aapli Pishvi initiative

Figure 34: Photograph of an outdoor market stall showing three women behind a table displaying colorful fabric swatches (table marked "5") while two men stand in front examining the items; trees and additional displays line the walkway in the background.

## Page 41 · via `ocr` · 0 table(s), 0 image(s)
...
राज्यात नवी मुंबई पहिल्या क्रमांकाचे आणि
...
## Page 45 · via `ocr` · 0 table(s), 0 image(s)
...
## Page 46 · via `ocr` · 0 table(s), 0 image(s)
