...
_SYSTEM = (
    ...
    "date_from and date_to_inclusive bounding any period — the FIRST and LAST "
    "dates to include. Copy the dates the request names; never add or subtract a "
    "day. For a single day both are that same day; for 'since/after' set only "
    "date_from; for 'before/until X' set only date_to_inclusive, to the day "
    "before X.\n"
    ...
    "to enumerate the themes/topics the collection covers); theme_children true "
...
_EXAMPLES = (
    ...
    "- 'what themes do you cover?' -> [database]; operation=list_themes\n"
    "- 'what are the sub-themes of Environment?' -> [database]; "
    "operation=list_themes, theme_children=true, theme=Environment\n"
    "- 'list all the sub-themes' -> [database]; operation=list_themes, "
    "theme_children=true\n"
    ...
    "operation=list, bundle=news, date_from=2023-01-01, "
    "date_to_inclusive=2023-12-31, output_format=list\n"
